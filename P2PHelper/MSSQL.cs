...
namespace P2PHelper
{
    public class MSSQL
    {
        ...
        public async Task<SqlDataReader> ExecuteStoredProcedureReturnDataReaderObject(string SPName, Dictionary<string, object> InPara)
        {
            SqlDataReader dr = null;
            try
            {
                ...
                foreach (KeyValuePair<string, object> param in InPara)
                {
                    cmd.Parameters.AddWithValue(param.Key, param.Value);
                }
        ...
        public async Task ExecuteStoredProcedure(string SPName, Dictionary<string, object> InPara)
        {
            try
            {
                SqlConnection con = new SqlConnection(ConnString);
