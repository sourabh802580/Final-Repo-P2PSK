      ...
      v.d(k, { default: () => lI }),
        (function (t) {
          (t.SVG_NS = "http://www.w3.org/2000/svg"),
            ...
            (t.svg = !!t.doc?.createElementNS?.(t.SVG_NS, "svg")
              ?.createSVGRect),
 ...
 - ${i}: ${e}`),
      ...
      T.jQuery &&
        (T.jQuery.fn.highcharts = function () {
          ...
          if (this[0])
            return t[0]
              ? (new w[P(t[0]) ? t.shift() : "Chart"](this[0], t[0], t[1]),
                this)
      ...
      let V = {
            ...
            return (
              !(function t(e, o, r, a) {
                ...
                j(e, function (i, h) {
                  ...
                  } else O(i, !0) && !i.nodeType ? ((r[h] = L(i) ? [] : {}), t(i, o[h] || {}, r[h], a + 1), 0 === Object.keys(r[h]).length && ("colorAxis" !== h || 0 !== a) && delete r[h]) : (e[h] !== o[h] || (h in e && !(h in o))) && "__proto__" !== h && "constructor" !== h && (r[h] = n[h]);
                });
              })(t, e, o, 0),
              o
            );
          ...
          offset: function (t) {
            ...
            return {
              ...
              left:
                i.left + (T.pageXOffset || e.scrollLeft) - (e.clientLeft || 0),
              width: i.width,
              height: i.height,
            };
          },
        ...
        th =
          w.isSafari && _.Intl && !_.Intl.DateTimeFormat.prototype.formatRange,
        tl = (t) => void 0 === t.main,
        td = class {
          constructor(t, e) {
          ...
          getTimeTicks(t, e, i, s) {
            ...
            if ((s ?? (s = 1), tc(e))) {
              if (
                ...
                h >= tg.second &&
                  (u = h >= tg.minute ? 0 : n * Math.floor(u / n)),
                h >= tg.minute &&
                  (g = h >= tg.hour ? 0 : n * Math.floor(g / n)),
                h >= tg.hour && (p = h >= tg.day ? 0 : n * Math.floor(p / n)),
                h >= tg.day &&
                  (c = h >= tg.month ? 1 : Math.max(1, n * Math.floor(c / n))),
        ...
        tv = {
          ...
          setOptions: function (t) {
            return (
              ...
              t.lang &&
                "locale" in t.lang &&
                tb.update({ locale: t.lang.locale }),
              t.lang?.chartTitle &&
                (ty.title = { ...ty.title, text: t.lang.chartTitle }),
              ty
            );
          },
        },
      ...
      class tL {
        ...
        constructor(t) {
          ...
          if ("object" == typeof t && void 0 !== t.stops)
            ...
            for (
              this.input = t = tL.names[t.toLowerCase()] || t,
                s = tL.parsers.length;
              s-- && !i;
          ...
          },
          {
            ...
            parse: function (t) {
              return [
                ...
                tT(t[2], 16),
                tT(t[3], 16),
                tC(t[4]) ? tT(t[4], 16) / 255 : 1,
              ];
            },
          },
        ]),
        (tL.useColorMix = tk.CSS?.supports(
          "color",
      ...
      class tB {
        ...
        strokeSetter() {
          this.elem.attr(
            this.prop,
            tO(this.start).tweenTo(tO(this.end), this.pos),
            void 0,
            !0
          );
        }
      ...
      function tY(t, e) {
        ...
        for (; i--; )
          tB.timers[i].elem !== t ||
            (e && e !== tB.timers[i].prop) ||
            (tB.timers[i].stopped = !0);
      }
      let tU = {
        ...
        t3 =
          t2 &&
          tJ(t2.createPolicy) &&
          t2.createPolicy("highcharts", { createHTML: (t) => t }),
        t5 = t3 ? t3.createHTML("") : "";
      class t6 {
            ...
            t0(t, (e, i) => {
              ...
              -1 === t6.allowedAttributes.indexOf(i) && (s = !1),
                -1 !==
                  ...
                  (s =
                    tQ(e) &&
                    t6.allowedReferences.some((t) => 0 === e.indexOf(t))),
                s ||
                  (tK(33, !1, void 0, {
            ...
            return (
              t1(e).forEach(function (e) {
                let o,
                  r = e.tagName,
                  a = e.textContent
                    ? w.doc.createTextNode(e.textContent)
                    : void 0,
      ...
      class eK {
        ...
        align(t, e, i, s = !0) {
          ...
          let h = eU(i, o[n], o),
            l =
              (h.x || 0) +
              (t.x || 0) +
              ((h.width || 0) - (t.width || 0)) * eR(t.align),
            d =
              (h.y || 0) +
              (t.y || 0) +
              ((h.height || 0) - (t.height || 0)) * eR(t.verticalAlign),
        ...
        getBBox(t, e) {
          let i,
            ...
            f = h.styledMode
              ? n && eK.prototype.getStyle.call(n, "font-size")
              : l.fontSize;
          if (
            (eD(d) &&
        ...
        constructor(t, e) {
          (this.onEvents = {}),
            ...
            (this.element =
              "span" === e || "body" === e
                ? eO(e)
                : eM.createElementNS(this.SVG_NS, e)),
            (this.renderer = t),
            (this.styles = {}),
            ez(this, "afterInit");
        }
        ...
        strokeWidth() {
          ...
          return (
            /px$/.test(t)
              ? (e = e$(t))
              : "" !== t &&
                (eL((i = eM.createElementNS(eT, "rect")), {
                  width: t,
                  "stroke-width": 0,
                }),
        ...
        titleSetter(t) {
          let e = this.element,
            i =
              ...
              eM.createElementNS(this.SVG_NS, "title");
        ...
        updateTransform(t = "transform") {
          ...
          eD(s) && g.push("matrix(" + s.join(",") + ")"),
            ...
            (eD(h) || eD(l)) &&
              g.push("scale(" + eU(h, 1) + " " + eU(l, 1) + ")"),
            g.length &&
              !(d || this).textPath &&
              (i?.element || e).setAttribute(t, g.join(" "));
        }
      ...
      class e9 extends eJ {
        ...
        updateBoxSize() {
          let t,
            ...
            s = this.padding,
            o = (this.bBox =
              (!e2(this.widthSetting) ||
                !e2(this.heightSetting) ||
                this.textAlign) &&
              eQ(e.textStr)
                ? e.getBBox(void 0, 0)
                : e9.emptyBBox);
          ...
          if (!t.textPath) {
            ...
            let i = this.baseline ? 0 : this.baselineOffset,
              s =
                ...
                e1(e) * (this.widthSetting ?? this.bBox.width);
            (s !== t.x || i !== t.y) &&
          ...
          modifyDOM() {
            ...
            let o = (t, o) => {
                ...
                if (n) {
                  ...
                  this.ellipsis &&
                    r &&
                    this.truncate(t, r, void 0, 0, s, l, iu);
              },
              r = (t) => {
          ...
          truncate(t, e, i, s, o, r, a) {
            ...
            if (((l.rotation = 0), s + (h = f(t.textContent.length)) > o)) {
              ...
              0 === g
                ...
                this.ellipsis &&
                  h > o &&
                  this.truncate(t, t.textContent || "", void 0, 0, o, r, iu);
            }
      ...
      class iU {
        constructor(t, e, i, s, o, r, a) {
          ...
          a || l.css(this.getStyle(s || {})),
            ...
            this.createElement("desc")
              .add()
              .element.appendChild(
                iv.createTextNode("Created with Highcharts 12.4.0")
              ),
          ...
          return (
            c ||
              ["hover", "select", "disabled"].forEach((t, e) => {
                m.push(
                  iX(m[0], t6.filterUserAttributes(p[e + 5] || u[t] || {}))
                ),
                  x.push(m[e + 1].style),
                  delete m[e + 1].style;
              }),
        ...
        rect(t, e, i, s, o, r) {
          ...
          return (
            this.styledMode ||
              (void 0 !== r && ((a["stroke-width"] = r), iN(a, n.crisp(a))),
              (a.fill = "none")),
        ...
        fontMetrics(t) {
          let e = iR(t)
              ? t
              : iG(eJ.prototype.getStyle.call(t, "font-size") || 0),
      ...
      class i6 extends eJ {
        ...
        updateTransform() {
          ...
          if (
            (e || i_(t, { marginLeft: `${g}px`, marginTop: `${u}px` }),
            "SPAN" === t.tagName)
          ) {
            let g,
            ...
            if (p !== i) {
              let e = this.textPxLength
                  ? this.textPxLength
                  : (i_(t, { width: "", whiteSpace: d || "nowrap" }),
                    t.offsetWidth),
                r = p || 0,
                a =
                  !s.styledMode &&
            ...
            e &&
              ...
              u !== this.cTT &&
                ...
                this.getSpanCorrection(
                  (!iK(o) && !this.textWidth && this.textPxLength) ||
                    t.offsetWidth,
                  g,
                  iQ(c)
                ));
                ...
                ? (super.updateTransform(),
                  i0(f) && i0(m)
                    ? (e.attr({
                        ...
                        height: t.offsetHeight,
                        "transform-origin":
                          t.getAttribute("transform-origin") || "0 0",
                      }),
        ...
        add(t) {
          ...
          return (
            (this.added = !0), this.alignOnAdd && this.updateTransform(), this
          );
        }
        textSetter(t) {
          t !== this.textStr &&
      ...
      (a || (a = {})).registerEventOptions = function (t, e) {
        (t.eventOptions = t.eventOptions || {}),
          st(e.events, function (e, i) {
            t.eventOptions[i] !== e &&
              (t.eventOptions[i] &&
                (se(t, i, t.eventOptions[i]), delete t.eventOptions[i]),
      ...
      let si = a,
        ...
        sf = class {
                ...
                (g
                  ? (f = (m = s.time.resolveDTLFormat(
                      i.dateTimeLabelFormats[
                        (!i.grid?.enabled && g.higherRanks[n]) || g.unitName
                      ]
                    )).main)
                  : sc(y) &&
          ...
          getPosition(t, e, i, s) {
            ...
            return (
              (n.y = so(n.y, -1e9, 1e9)),
              sl(this, "afterGetPosition", { pos: n }),
              n
            );
          }
          ...
          handleOverflow(t) {
            ...
            l || "justify" !== i.overflow
              ? l < 0 && s - d * c < a
                ...
                : l > 0 &&
                  s + d * c > n &&
                  (f = Math.round((o - s) / Math.cos(l * ss)))
              : (s - d * c < a
                  ? (g = t.x + g * (1 - d) - a)
              ...
              f &&
                ...
                (this.shortenLabel
                  ...
                  : h.css(
                      sh(
                        {},
                        { width: Math.floor(f) + "px", lineClamp: +!e.isRadial }
                      )
                    ));
          }
          moveLabel(t, e) {
      ...
      class s$ {
        ...
        getPlotLinePath(t) {
          ...
          return (
            sE(this, "getPlotLinePath", b, function (t) {
              (g = f =
                (c = sS(
                  (c = sX(c, e.translate(a, void 0, void 0, r))),
                  -1e9,
                  1e9
                )) + d),
                (u = m = h - c - d),
        ...
        setTickInterval(t) {
          let {
            ...
            M,
            S =
              sN(h.tickInterval) && h.tickInterval >= 0
                ? h.tickInterval
                : void 0,
            T,
            C,
        ...
        setAxisSize() {
          let t = this.chart,
            ...
            o = (this.width = Math.round(
              sF(sX(e.width, t.plotWidth - i[3] + i[1]), t.plotWidth)
            )),
            r = (this.height = Math.round(
              sF(sX(e.height, t.plotHeight - i[0] + i[2]), t.plotHeight)
            )),
            a = (this.top = Math.round(
              sF(sX(e.top, t.plotTop + i[0]), t.plotHeight, t.plotTop)
            )),
            n = (this.left = Math.round(
              sF(sX(e.left, t.plotLeft + i[3]), t.plotWidth, t.plotLeft)
            ));
        ...
        unsquish() {
          ...
          return (
            (this.autoRotation = p),
            (this.labelRotation = sX(d, sN(r) ? r : 0)),
            t.step ? s : l
          );
        }
        getSlotWidth(t) {
          ...
          if (
            ...
            v &&
              ...
              (k +=
                f *
                (i
                  ? sX(c.y, t.tickRotCorr.y + f * c.distance)
                  : sX(c.x, f * c.distance)))),
                  ...
                  (h
                    .attr({
                      stroke:
                        i.color ||
                        (n
                          ? tL.parse("#ccd3ff").setOpacity(0.25).get()
                          : "#cccccc"),
      ...
      class oO {
        ...
        destroy() {
          this.label && (this.label = this.label.destroy()),
            ...
            this.renderer &&
              ((this.renderer = this.renderer.destroy()), ox(this.container)),
        ...
        refresh(t, e) {
          ...
          n.points = void 0;
          let m = n.series;
          if (((this.distance = oC(m.tooltipOptions.distance, 16)), !1 === f))
            this.hide();
          else {
                  ...
                  return (
                    ...
                    c ||
                      o
                        ...
                        .attr({
                          stroke:
                            n.borderColor || e.color || a.color || "#333333",
                        }),
                    o
                  );
                })(d.tt, r, s.toString())),
        ...
        updatePosition(t) {
          let {
            ...
            f = (d || (l && this.getFixedPosition) || this.getPosition).call(
              this,
              h,
              n,
              t
          ...
          if (a && i) {
            ...
            (b = (o.borderWidth || 0) + 2 * s + 2),
              a.setSize(
                of(h + b, 0, m.documentElement.clientWidth) - 1,
                n + b,
                !1
              ),
              (1 !== g || 1 !== u) &&
      ...
      class oq {
        ...
        destroy() {
          if (!this.destroyed) {
            ...
            t.legendItem && i.legend.destroyItem(t),
              ...
              s?.enabled
                ? (this.animateBeforeDestroy(), oV(a, r.duration))
                : a(),
              i.pointCount--;
          }
          this.destroyed = !0;
        ...
        getNestedProperty(t) {
          if (t)
            return 0 === t.indexOf("custom.") ? oX(t, this.options) : this[t];
        }
        getZone() {
          let t = this.series,
            e = t.zones,
        ...
        update(t, e, i, s) {
          ...
          function d() {
            ...
            a.dataTable.setRow(c, o),
              (l.data[o] =
                oY(l.data[o], !0) || oY(t, !0) ? r.options : o$(t, l.data[o])),
          ...
          if (
            ...
            g &&
              this.graphic.animate(
                g,
                o$(d.options.chart.animation, n.animation, r.animation)
              ),
              m && m.hide();
          } else
            t &&
        ...
        drag(t) {
          ...
          if (
            ...
            this.hasZoom &&
              ...
              e.styledMode ||
                m.attr({ fill: a || oJ("#334eff").setOpacity(0.25).get() })),
              m && m.attr(l),
              f && !m && c && e.pan(t, o);
          }
        }
          ...
          let a = [],
            n = function (t) {
              return (
                t.visible &&
                !(!o && t.directTouch) &&
                ri(t.options.enableMouseTracking, !0)
              );
            },
            h = e,
            l,
        ...
        normalize(t, e) {
          let i = t.touches,
            s = i
              ? i.length
                ? i.item(0)
                : ri(i.changedTouches, t.changedTouches)[0]
              : t;
        ...
        setDOMEvents() {
          ...
          for (; i && "BODY" !== i.tagName; )
            this.eventsToUnbind.push(
              ...
              (i = i.parentElement);
          this.eventsToUnbind.push(
            o2(t, "touchstart", this.onContainerTouchStart.bind(this), {
              passive: !1,
            }),
      ...
      let { setLength: rn, splice: rh } = d,
        ...
        rp = class {
          ...
          deleteRows(t, e = 1) {
            ...
            rl(this, "afterDeleteRows", { rowIndex: t, rowCount: e }),
              (this.versionTag = rc());
          }
          getColumn(t, e) {
          ...
          setColumns(t, e, i) {
            ...
            rd(t, (t, e) => {
              ...
              i?.silent ||
                (rl(this, "afterSetColumns"), (this.versionTag = rc()));
          }
          setRow(t, e = this.rowCount, i, s) {
            ...
            rd(t, (t, a) => {
              ...
              n &&
                (i ? (n = rh(n, e, 0, !0, [t]).array) : (n[e] = t), (o[a] = n));
            }),
      ...
      class r0 {
        ...
        autoIncrement(t) {
          ...
          if (
            ((this.pointInterval = e =
              rK(this.pointInterval, i.pointInterval, 1)),
            o && rV(t) && (e *= t),
            s)
          ) {
            let t = r.toParts(a);
        ...
        getName() {
          return (
            this.options.name ??
            rL(this.chart.options.lang.seriesName, this, this.chart)
          );
        }
        getCyclic(t, e, i) {
          let s,
            ...
            t.forEach((t, e) => {
              ...
              p || rV(g)
                ? (-1 === (l = this.findPointIndex(d, c)) || void 0 === l
                    ? a.push(t)
                    : r[l] && t !== i.data?.[l]
                    ? (r[l].update(t, !1, void 0, !1),
                      (r[l].touched = !0),
                      s && (c = l + 1))
                    : r[l] && (r[l].touched = !0),
                  (!n || e !== l || o?.enabled || this.hasDerivedData) &&
                    (h = !0))
                : a.push(t);
            }, this),
            h)
          ...
          for (p = 0; p < a; p++) {
            let t,
              ...
              M =
                e &&
                o.stacking?.stacks[
                  (this.negStacks && k < (d ? 0 : l) ? "-" : "") + this.stackKey
                ];
            (a.plotX = rV((g = i.translate(y, !1, !1, !1, !0, n)))
              ? rD(x(g))
              : void 0),
              e &&
                this.visible &&
                ...
                b &&
                  ...
                  (a.percentage =
                    rN(a.y) && b.total ? (a.y / b.total) * 100 : void 0),
                  (a.stackY = k),
            ...
            for (e = 0; e < t.length; e++) {
              ...
              if (
                ...
                (n = this.markerAttribs(i, i.selected && "select")),
                  this.enabledDataSorting &&
                    (i.startXPos = f.reversed ? -(n.width || 0) : f.width);
                let e = !1 !== i.isInside;
                if (
                  (!s &&
                    e &&
          ...
          for (
            rG(s, "destroy", { keepEventsForUpdate: t }),
              ...
              (s.axisTypes || []).forEach(function (t) {
                (i = s[t]),
                  i?.series &&
                    (rW(i.series, s), (i.isDirty = i.forceRedraw = !0));
              }),
            ...
            rQ(
              function () {
                (e.kdTree = (function t(i, s, o) {
                  ...
                  e.getValidPoints(void 0, !e.directTouch, i?.nullInteraction),
                  s,
                  s
                )),
                  (e.buildingKdTree = !1);
        ...
        removePoint(t, e, i) {
          let s = this,
            ...
            h = r[t],
            l = function () {
              [a?.length === r.length ? a : void 0, r, s.options.data]
                .filter(rN)
                .forEach((e) => {
                  e.splice(t, 1);
                }),
      ...
      class ag {
        ...
        colorizeItem(t, e) {
          ...
          if (
            ((t instanceof r1 || t instanceof oK) &&
        ...
        render() {
          ...
          (this.itemX = s),
            ...
            ac(
              o,
              (t, e) =>
                (t.options?.legendIndex || 0) - (e.options?.legendIndex || 0)
            ),
            ...
            i &&
              i
                ...
                .on("mouseout", function () {
                  s.chart.styledMode ||
                    e.css(an(t.visible ? s.itemStyle : s.itemHiddenStyle)),
                    c(""),
                    r.removeClass(h),
                    t.setState();
                })
      ...
      class a0 {
        ...
        init(t, e) {
          aW(this, "init", { args: arguments }, function () {
            ...
            (this.userOptions = az({}, t)),
              (this.renderTo = aY(o) ? aw.getElementById(o) : o) ||
                aN(13, !0, this),
              (this.margin = []),
              (this.spacing = []),
        ...
        getChartSize() {
          ...
          (this.chartWidth = Math.max(0, e || s.width || 600)),
            (this.chartHeight = Math.max(
              0,
              a_(i, this.chartWidth) || (o ? 400 : s.height)
            )),
            (this.containerBox = s);
        }
        temporaryDisplay(t) {
          ...
          if (t)
            for (; e?.style; )
              e.hcOrigStyle && (aO(e, e.hcOrigStyle), delete e.hcOrigStyle),
                e.hcOrigDetached &&
                  (aw.body.removeChild(e), (e.hcOrigDetached = !1)),
                (e = e.parentNode);
          else
            for (
              ;
        ...
        getContainer() {
          ...
          (this.container = l),
            ...
            h !== this.chartWidth &&
              ((h = this.chartWidth),
              this.styledMode ||
                aO(l, { width: aV(i.style?.width, h + "px") })),
        ...
        propFromSeries() {
          ...
          ["inverted", "angular", "polar"].forEach(function (a) {
            for (
              e = aC[o.type], i = o[a] || (e && e.prototype[a]), t = r?.length;
              !i && t--;
        ...
        showLoading(t) {
          ...
          r ||
            ...
            a ||
              ((e.loadingSpan = a =
                aL("span", { className: "highcharts-loading-inner" }, null, r)),
              aA(e, "redraw", o)),
        ...
        update(t, e, i, s) {
          ...
          let p = c?.width,
            g =
              c && (aY(c.height) ? a_(c.height, p || n.chartWidth) : c.height);
          ...
          setOffset(t, e, i, s, o, r) {
            ...
            if (h && p) {
              ...
              (p.x -= o),
                ...
                i &&
                  no.prototype.justifyDataLabel.call(
                    n,
                    h,
                    a,
                    h.alignAttr,
      ...
      (nY.defaultOptions = nG(nF.defaultOptions)),
      ...
      class ht extends r1 {
        animate(t) {
          ...
          t && h
            ? ((d.scaleY = 0.001),
              ...
              l
                ? (d.translateX =
                    (i += a ? -Math.floor(h[0]) : Math.ceil(h[2])) - o.len)
        ...
        getColumnMetrics() {
          ...
          let l = Math.min(
            ...
            p = Math.min(
              ...
              n8(e.pointWidth, c * (1 - 2 * e.pointPadding))
            ),
            g = (t.columnIndex || 0) + +!!r;
          return (
            (t.columnMetrics = {
        ...
        pointAttribs(t, e) {
          let i = this.options,
            ...
            g =
              t?.isNull && i.nullInteraction ? 0 : t?.opacity ?? i.opacity ?? 1;
          t &&
            this.zones.length &&
            ((n = t.getZone()),
            (l =
            ...
            e &&
              ...
              (l =
                a.color ||
                (void 0 !== h && nJ(l).brighten(a.brightness).get()) ||
                l),
              (d = a[o] || d),
              (p = a[r] || p),
              (c = a.dashStyle || c),
          ...
          ha(this, "drawDataLabels"),
            i.hasDataLabels?.() &&
              ...
              t.forEach((t) => {
                let a = t.dataLabels || [],
                  h = t.color || i.color;
                hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach(
                  (n, l) => {
                    let c =
                        n.enabled &&
      ...
      !(function (t) {
        (t.getCenter = function () {
          ...
          for (
            !e.angular || this instanceof r1 || (g[3] = 0), c = 0;
            c < 4;
            ++c
          )
            (p = g[c]),
      ...
      let ll = {
          compose: function (t) {
            ...
            e.hideOverlappingLabels ||
              ((e.hideOverlappingLabels = la), le(t, "render", lh));
          },
        },
          ...
          for (let s of this.points) {
            ...
            if ("roundedRect" === s.shapeType && a) {
              ...
              !g &&
                ...
                g || (g = "end");
              let u =
                Math.min(lm(o.radius, n), n / 2, "all" === g ? h / 2 : 1 / 0) ||
                0;
              "end" === g && (p && (d -= u), (c += u)),
                lg(a, { brBoxHeight: c, brBoxY: d, r: u });
            }
          }
        }
      }
      ...
      !(function (t) {
        ...
        function i(t, e) {
          ...
          !e &&
            ...
            i.rules &&
            i.rules.forEach((t) => {
              void 0 === t._id && (t._id = lO()),
                this.matchResponsiveRule(t, o);
            }, this);
          let a = lP(
            ...o
              .map((t) => lA(i?.rules || [], (e) => e._id === t))
        ...
        t.compose = function (t) {
          ...
          return (
            s.matchResponsiveRule ||
              lC(s, { matchResponsiveRule: e, setResponsive: i }),
            t
          );
        };
      })(b || (b = {}));
