...
!(function (e) {
  ...
  x.extend(_.prototype, {
          ...
          "absolute" === d
            ? ((t = x(b[0].offsetParent)),
              ...
              ("button-right" !== p.align &&
                ...
                (a = n.left - l.width + b.outerWidth()),
              ("dt-container" !== p.align && "container" !== p.align) ||
                (a < n.left && (a = -n.left)),
              s.left + a + l.width > x(g).width() &&
                (a = x(g).width() - l.width - s.left),
              d.left + a < 0 && (a = -d.left),
    ...
    (_.instanceSelector = function (t, s) {
      var r, a, l;
      return null == t
        ? x.map(s, function (t) {
            return t.inst;
    ...
    (_.stripData = function (t, n) {
      return (t =
        "string" == typeof t &&
        ((t = _.stripHtmlScript(t)),
        (t = _.stripHtmlComments(t)),
    ...
    (_.stripHtmlComments = function (t) {
      for (
        var n;
        (t = (n = t).replace(
          /(<!--.*?--!?>)|(<!--[\S\s]+?--!?>)|(<!--[\S\s]*?$)/g,
