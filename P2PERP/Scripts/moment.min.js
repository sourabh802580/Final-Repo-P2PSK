...
!(function (e, t) {
  ...
  function Fe(e) {
    return null != e
      ? (He(this, e), n.updateOffset(this, !0), this)
      : $(this, "Month");
  }
  function Le() {
    function e(e, t) {
  ...
  C("H", ["HH", 2], 0, "hour"),
    ...
    C("hmmss", 0, 0, function () {
      return "" + nt.apply(this) + T(this.minutes(), 2) + T(this.seconds(), 2);
    }),
    C("Hmm", 0, 0, function () {
            ...
            (function (e) {
              ...
              (t = e._w),
                null != t.GG || null != t.W || null != t.E
                  ? ((r = 1),
                    (a = 4),
                    (n = xt(t.GG, e._a[ve], Ze(Wt(), 1, 4).year)),
                    (s = xt(t.W, 1)),
                    ((i = xt(t.E, 1)) < 1 || i > 7) && (u = !0))
        ...
        for (
          ...
          (r = i[t]),
            (s = (l.match(fe(r, e)) || [])[0]) &&
              ...
              (d += s.length)),
            W[r]
              ? (s ? (f(e).empty = !1) : f(e).unusedTokens.push(r), we(r, s, e))
          ...
          v(t)
            ...
            : (l(t)
                ...
                ? (function (e) {
                    ...
                    if (0 === u)
                      return (
                        (f(e).invalidFormat = !0), void (e._d = new Date(NaN))
                      );
                    for (i = 0; i < u; i++)
                      (r = 0),
                        (a = !1),
  ...
  function Rt(e, t, n, r, o) {
    ...
    return (
      ...
      (l._f = t),
      (l._strict = r),
      (u = new p(yt(Pt(l))))._nextDay && (u.add(1, "d"), (u._nextDay = void 0)),
      u
    );
  }
  function Wt(e, t, n, s) {
  ...
  function Lt(e) {
    ...
    (this._isValid = (function (e) {
      var t,
        ...
        i = Ft.length;
      for (t in e)
        if (r(e, t) && (-1 === pe.call(Ft, t) || (null != e[t] && isNaN(e[t]))))
          return !1;
      for (n = 0; n < i; ++n)
        if (e[Ft[n]]) {
          if (s) return !1;
  ...
  function It(e, t) {
    ...
    return t._isUTC
      ? ((s = t.clone()),
        (i = (v(e) || l(e) ? e.valueOf() : Wt(e).valueOf()) - s.valueOf()),
  ...
  (bn.add = en),
    ...
    (bn.endOf = function (e) {
      ...
      switch (((s = this._isUTC ? _n : mn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t +=
              dn - fn(t + (this._isUTC ? 0 : this.utcOffset() * hn), dn) - 1);
          break;
        case "minute":
    ...
    (bn.startOf = function (e) {
      ...
      switch (((s = this._isUTC ? _n : mn), e)) {
        ...
        case "hour":
          (t = this._d.valueOf()),
            (t -= fn(t + (this._isUTC ? 0 : this.utcOffset() * hn), dn));
          break;
        case "minute":
  ...
  (Tn.calendar = function (e, t, n) {
    ...
    (Tn.months = function (e, t) {
      return e
        ? s(this._months)
          ...
          : this._months[
              (this._months.isFormat || Re).test(t) ? "format" : "standalone"
            ][e.month()]
        : s(this._months)
        ? this._months
    ...
    (Tn.monthsShort = function (e, t) {
      return e
        ? s(this._monthsShort)
          ...
          : this._monthsShort[Re.test(t) ? "format" : "standalone"][e.month()]
        : s(this._monthsShort)
        ? this._monthsShort
    ...
    (Tn.monthsShortRegex = function (e) {
      return this._monthsParseExact
        ...
        : (r(this, "_monthsShortRegex") || (this._monthsShortRegex = We),
    ...
    (Tn.weekdaysShortRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = Xe),
    ...
    (Tn.weekdaysMinRegex = function (e) {
      return this._weekdaysParseExact
        ...
        : (r(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Ke),
    ...
    (n.lang = M("moment.lang is deprecated. Use moment.locale instead.", ft)),
    (n.langData = M(
  ...
  return (
    ...
    (us.as = function (e) {
      ...
      if ("month" === (e = V(e)) || "quarter" === e || "year" === e)
        switch (((t = this._days + s / 864e5), (n = this._months + Hn(t)), e)) {
          case "month":
            return n;
          case "quarter":
            return n / 3;
