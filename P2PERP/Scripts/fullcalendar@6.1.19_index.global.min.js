...
var FullCalendar = (function (e) {
  ...
  class en {
    constructor(e) {
      ...
      for (let i in e)
        ...
        } else (t[i] = e[i]), i in Yt && (r = Math.min(Yt[i], r));
              ...
              (function (e, t, n, r, i) {
                ...
                !1 === r.meridiem
                  ...
                  : "lowercase" === r.meridiem &&
                    (e = e.replace(Zt, (e) => e.toLocaleLowerCase()));
  ...
  function xn(e, t, n = {}) {
    if (e === t) return !0;
    for (let r in t) if (!(r in e) || !_n(e[r], t[r], n[r])) return !1;
  ...
  class Pn {
    ...
    timestampToMarker(e) {
      return "local" === this.timeZone
        ...
        ? Bt(this.namedTimeZoneImpl.timestampToArray(e))
        : new Date(e);
    }
    offsetForMarker(e) {
      return "local" === this.timeZone
        ? -Pt(Ht(e)).getTimezoneOffset()
        : "UTC" === this.timeZone
        ? 0
        : this.namedTimeZoneImpl
        ? this.namedTimeZoneImpl.offsetForArray(Ht(e))
        : null;
    }
    toDate(e, t) {
      return "local" === this.timeZone
        ...
        ? new Date(
            e.valueOf() -
              1e3 * this.namedTimeZoneImpl.offsetForArray(Ht(e)) * 60
          )
  ...
  function Bn(e) {
    ...
    for (
      n.debounceRendering = function (e) {
        ...
        U(p(jn, {}), document.createElement("div"));
      r.length;
  ...
  (Hn.prototype.classes = {}),
    (Hn.prototype.iconClasses = {}),
    (Hn.prototype.baseIconClass = ""),
    (Hn.prototype.iconOverridePrefix = "");
  class jn extends D {
    render() {
      return p("div", {});
    }
  ...
  const Ln = zn({});
  function Wn(e, t, n, r, i, s, o, a, l, c, d, u, h, f) {
    return {
      dateEnv: i,
      nowManager: s,
      options: n,
      ...
      createScrollResponder: (e) =>
        new Un(e, d, ft(n.scrollTime), n.scrollTimeReset),
  ...
  class Fn extends D {
    shouldComponentUpdate(e, t) {
      return (
        !xn(this.props, e, this.propEquality) ||
        !xn(this.state, t, this.stateEquality)
      );
    }
    safeSetState(e) {
      xn(
    ...
    constructor() {
      super(...arguments),
        ...
        (this.handleEl = (e) => {
          ...
          (t.customRenderingReplaces && qn(n, t)) || this.updateElRef(e);
        }),
        (this.updateElRef = (e) => {
          this.props.elRef && Gn(this.props.elRef, e);
        });
    }
    render() {
        ...
        r &&
          i(
            Object.assign(
              ...
              { elClasses: (n.elClasses || []).filter(Zn) }
            )
          );
      }
    }
  ...
  class $n extends D {
    constructor() {
      super(...arguments),
        (this.InnerContent = Jn.bind(void 0, this)),
        (this.handleEl = (e) => {
          (this.el = e),
            this.props.elRef &&
              (Gn(this.props.elRef, e),
    ...
    render() {
      ...
      return p(
        $n,
        {
          ...
          elTag: e.elTag || "div",
          elAttrs: e.elAttrs,
          elClasses: [...er(e.viewSpec), ...(e.elClasses || [])],
          elStyle: e.elStyle,
          renderProps: r,
  ...
  function cr(e, t = ft(0)) {
    ...
    return (
      e.start && ((n = Mt(e.start)), r && r <= n && (r = wt(n, 1))),
      { start: n, end: r }
    );
  }
  function dr(e) {
  ...
  function ur(e, t, n, r) {
    return "year" === r
      ? ft(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? ft(n.diffWholeMonths(e, t), "month")
      : _t(e, t);
  }
  class hr {
    constructor(e) {
    ...
    adjustActiveRange(e) {
      ...
      return (
        n &&
          (vt(r) < 0 && ((s = Mt(s)), (s = t.add(s, r))),
          vt(i) > 1 && ((o = Mt(o)), (o = wt(o, -1)), (o = t.add(o, i)))),
        { start: s, end: o }
      );
    }
    buildRangeFromDuration(e, t, n, r) {
      ...
      return (
        vt(n) <= 1 &&
          this.isHiddenDay(i) &&
          ((i = this.skipHiddenDays(i, t)), (i = Mt(i))),
        c(),
    ...
    buildDateIncrement(e) {
      ...
      return (
        n || ((t = this.props.dateAlignment) ? ft(1, t) : e || ft({ days: 1 }))
      );
    }
    refineRange(e) {
      if (e) {
  ...
  function gr(e, t, n) {
    ...
    for (let e in o) {
      ...
      if (n.recurringDef) {
        ...
        let l = pr(n, o, t, r, i.recurringTypes);
        for (let t of l) {
          let n = fr(e, { start: t, end: r.add(t, o) });
          a[n.instanceId] = n;
        }
      }
    }
  ...
  const mr = {
    ...
    vr = { start: yn, end: yn, date: yn, allDay: Boolean },
    yr = Object.assign(Object.assign(Object.assign({}, mr), vr), {
      extendedProps: yn,
    });
  function br(e, t, n, r, i = Sr(n), s, o) {
    let { refined: a, extra: l } = Er(e, n, i),
      c = (function (e, t) {
        let n = null;
        e && (n = e.defaultAllDay);
    ...
    if (u) {
      let e = Ar(a, l, t ? t.sourceId : "", u.allDay, u.hasEnd, n, s),
        r = fr(e.defId, u.range, u.forcedStartTzo, u.forcedEndTzo);
      return (
  ...
  function Er(e, t, n = Sr(t)) {
    return vn(e, n);
  }
  function Sr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, kr), yr),
  ...
  function Dr(e, t, n, r, i, s) {
    let o = { defs: {}, instances: {} },
      a = Sr(n);
    for (let l of e) {
      let e = br(l, t, n, r, a, i, s);
      e && wr(e, o);
    }
    return o;
  }
  function wr(e, t = { defs: {}, instances: {} }) {
    return (
  ...
  function Br(e) {
    return Object.assign(
      Object.assign(Object.assign({}, kr), Pr),
    ...
    switch (t.type) {
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, s) {
          if (t && n === t.latestFetchId) {
            let n = Dr(zr(i, t, s), t, s);
            return r && (n = gr(n, r, s)), xr(Wr(e, t.sourceId), n);
          }
          return e;
      ...
      case "RESET_RAW_EVENTS":
        return (function (e, t, n, r, i) {
          ...
          return gr(Dr(zr(n, t, i), t, i, !1, s, o), r, i);
      ...
      case "RESET_EVENTS":
        return t.eventStore;
      case "MERGE_EVENTS":
        return xr(e, t.eventStore);
      case "PREV":
      case "NEXT":
      case "CHANGE_DATE":
      case "CHANGE_VIEW_TYPE":
        return r ? gr(e, r.activeRange, i) : e;
      case "REMOVE_EVENTS":
        return (function (e, t) {
      ...
      case "REMOVE_EVENT_SOURCE":
        return Wr(e, t.sourceId);
      case "REMOVE_ALL_EVENT_SOURCES":
        return _r(e, (e) => !e.sourceId);
  ...
  function zr(e, t, n) {
    ...
    return i && (e = Ur(e, i)), r && (e = Ur(e, r)), e;
  }
  function Ur(e, t) {
    let n;
    if (t) {
      ...
      (function (e) {
        ...
        t =
          !0 === e
            ...
            ? [e]
            : [];
        return (t = t.map((e) => Object.assign(Object.assign({}, Vr), e))), t;
      })(e),
      null,
      t
    );
  ...
  function Qr(e, t, n) {
    n.emitter.trigger(
      "select",
      Object.assign(Object.assign({}, qr(e, n)), {
  ...
  function Yr(e, t, n) {
    ...
    return (
      e
        ? ((s = Mt(s)), (s = r.add(s, i.defaultAllDayEventDuration)))
  ...
  function Zr(e, t, n, r) {
    ...
    for (let t in e.defs) {
      let o = e.defs[t];
      s.defs[t] = Xr(o, i[t], n, r);
    }
    for (let t in e.instances) {
      let o = e.instances[t],
        a = s.defs[o.defId];
      s.instances[t] = $r(o, a, i[o.defId], n, r);
    }
    return s;
  }
  function Xr(e, t, n, r) {
  ...
  function $r(e, t, n, r, i) {
    ...
    return (
      ...
      a &&
        (l.range = {
          start: l.range.start,
          end: Yr(t.allDay, l.range.start, i),
        }),
      t.allDay &&
        (l.range = { start: Mt(l.range.start), end: Mt(l.range.end) }),
      l.range.end < l.range.start &&
        (l.range.end = Yr(t.allDay, l.range.start, i)),
      l
    );
  }
  class Jr {
  ...
  class Kr {
    ...
    setProp(e, t) {
      if (e in vr)
        ...
        (t = mr[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in mr)
        (t = mr[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in kr) {
        let n = kr[e](t);
        (n =
          "color" === e
    ...
    setStart(e, t = {}) {
      let { dateEnv: n } = this._context,
        r = n.createMarker(e);
      if (r && this._instance) {
        let e = ur(this._instance.range.start, r, n, t.granularity);
        t.maintainDuration
    ...
    setEnd(e, t = {}) {
      ...
      if ((null == e || ((n = r.createMarker(e)), n)) && this._instance)
        if (n) {
          let e = ur(this._instance.range.end, n, r, t.granularity);
    ...
    setDates(e, t, n = {}) {
      ...
      if (o && (null == t || ((r = i.createMarker(t)), r)) && this._instance) {
        ...
        !0 === n.allDay && (e = lr(e));
        let t = ur(e.start, o, i, n.granularity);
        if (r) {
          let o = ur(e.end, r, i, n.granularity);
          (l = o),
            (a = t).years === l.years &&
            a.months === l.months &&
            a.days === l.days &&
  ...
  function ti(e, t, n) {
    ...
    for (let e in i) {
      let n = i[e],
        a = r[n.defId];
      n.instanceId !== o && s.push(new Kr(t, a, n));
    }
    return s;
  }
  function ni(e, t, n, r) {
  ...
  const yi = { start: yn, end: yn, allDay: Boolean };
  function bi(e, t, n) {
    let r = (function (e, t) {
        let { refined: n, extra: r } = vn(e, yi),
      ...
      fetch(t, r).then((e) => {
        if (e.ok)
          return e.json().then(
            (t) => [t, e],
            () => {
              throw new wi("Failure parsing JSON", e);
            }
          );
        throw new wi("Request failed", e);
      })
    );
  }
  let Ri;
  ...
  class _i extends Vn {
    ...
    render() {
      ...
      return xi() || s.push("fc-liquid-hack"), e.children(s, i, r, n);
    }
    componentDidMount() {
  ...
  class Ii extends D {
    constructor(e, t) {
      super(e, t),
        (this.handleRefresh = () => {
          ...
          e.state.nowDate.valueOf() !== this.state.nowDate.valueOf() &&
    ...
    computeTiming() {
      let e,
        ...
        i = r.nowManager.getDateMarker(),
        { nowIndicatorSnap: s } = r.options;
      if (
        ("auto" === s &&
          (s = /year|month|week|day/.test(n.unit) || 1 === (n.unitValue || 1)),
        s)
      ) {
        (e = r.dateEnv.startOf(i, n.unit)),
          (t = r.dateEnv.add(e, ft(1, n.unit)).valueOf() - i.valueOf());
      } else (e = i), (t = 6e4);
      return (
        (t = Math.min(864e5, t)),
        { state: { nowDate: e, todayRange: Oi(e) }, waitMs: t }
      );
    }
  ...
  class Ni {
    ...
    select(e, t) {
      ...
      let r = this.getCurrentData(),
        i = bi(n, r.dateEnv, ft({ days: 1 }));
      i &&
        (this.dispatch({ type: "SELECT_DATES", selection: i }), Qr(i, null, r));
    }
    unselect(e) {
      let t = this.getCurrentData();
      t.dateSelection &&
    ...
    addEvent(e, t) {
      if (e instanceof Kr) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: wr({ def: t, instance: n }),
            }),
      ...
      if (i) {
        ...
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: wr(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
    ...
    triggerEventAdd(e) {
      ...
      t.trigger("eventAdd", {
        ...
        relatedEvents: [],
        revert: () => {
          this.dispatch({ type: "REMOVE_EVENTS", eventStore: ei(e) });
        },
      });
    }
    getEventById(e) {
      ...
      for (let i in n) {
        let s = n[i];
        if (s.publicId === e) {
          if (s.recurringDef) return new Kr(t, s, null);
          for (let e in r) {
            let n = r[e];
            if (n.defId === s.defId) return new Kr(t, s, n);
          }
        }
      }
      return null;
  ...
  class Li {
    ...
    splitProps(e) {
      let t = this.getKeyInfo(e),
        ...
        l = {};
      this.eventUiBuilders = An(t, (e, t) => this.eventUiBuilders[t] || Gt(Wi));
      for (let n in t) {
        let c = t[n],
          d = s[n] || Ui,
      ...
      if (e) {
        let n = this._splitEventStore(
          ...
          s = (r) => {
            t[r] ||
              (t[r] = {
                affectedEvents: n[r] || Ui,
                mutatedEvents: i[r] || Ui,
                isEvent: e.isEvent,
              });
          };
        for (let e in n) s(e);
  ...
  function Fi(e, t, n, r) {
    return {
      dow: e.getUTCDay(),
      isDisabled: Boolean(r && (!r.activeRange || !ar(r.activeRange, e))),
  ...
  function qi(e, t, n = "day", r = !0) {
    ...
    if (s.navLinks) {
      ...
      return Object.assign(
        { title: at(s.navLinkHint, [a, e], a), "data-navlink": "" },
        r ? Qe(l) : { onClick: l }
      );
    }
    return { "aria-label": a };
  ...
  class rs {
    ...
    similarTo(e) {
      return (
        is(this.tops || [], e.tops || []) &&
        is(this.bottoms || [], e.bottoms || []) &&
        is(this.lefts || [], e.lefts || []) &&
        is(this.rights || [], e.rights || [])
      );
    }
  }
  function is(e, t) {
  ...
  class cs {
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (gs(r, t.level, t.levelCoord), gs(n, t.level, [e]))
        : gs(n[t.level], t.lateral, e),
        (this.stackCnts[us(e)] = t.stackCnt);
    }
    findInsertion(e) {
      let {
          levelCoords: t,
      ...
      let h = -1;
      return (
        u < s && t[u] === o && (h = ps(n[u], e.span.end, ds)[0]),
        {
          touchingLevel: a,
          touchingLateral: l,
          touchingEntry: c,
  ...
  class Ds extends Vn {
    render() {
      ...
      let h = Object.assign(
        Object.assign(Object.assign({ date: u, view: r }, i.extraRenderProps), {
          text: c,
        }),
        a
      );
  ...
  class Rs extends Vn {
    constructor() {
      super(...arguments), (this.createDayHeaderFormatter = Gt(xs));
    }
    render() {
      let { context: e } = this,
        {
  ...
  class ks {
    ...
    sliceNowDate(e, t, n, r, ...i) {
      return this._sliceDateSpan(
        { range: { start: e, end: Ct(e, 1) }, allDay: !1 },
        t,
        n,
        {},
        r,
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(gr(e, Ms(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
    _sliceEventStore(e, t, n, r, ...i) {
      if (e) {
        let s = ni(e, t, Ms(n, Boolean(r)), r);
        return {
    ...
    _sliceInteraction(e, t, n, r, ...i) {
      if (!e) return null;
      let s = ni(e.mutatedEvents, t, Ms(n, Boolean(r)), r);
      return {
    ...
    _sliceDateSpan(e, t, n, r, i, ...s) {
      if (!e) return [];
      let o = Ms(t, Boolean(n)),
        a = rr(e.range, o);
      if (a) {
        let t = (function (e, t, n) {
            let r = Er({ editable: !1 }, n),
              i = Ar(r.refined, r.extra, "", e.allDay, !0, n);
            return {
              def: i,
              ui: ai(i, t),
              instance: fr(i.defId, e.range),
              range: e.range,
              isStart: !0,
              isEnd: !0,
            };
    ...
    sliceEventRange(e, t) {
      ...
      this.forceDayIfListItem &&
        ...
        (n = { start: n.start, end: wt(n.start, 1) });
  ...
  function Os(e, t, n) {
    return !!or(t.validRange, e.range) && Ns({ dateSelection: e }, n);
  }
  function Ns(e, t) {
    ...
    return (t.pluginHooks.isPropsValid || Ps)(r, t);
  }
  function Ps(e, t, n = {}, r) {
    return (
      !(
        ...
        !(function (e, t, n, r) {
          let i = t.getCurrentData(),
            ...
            a = o.defs,
            l = o.instances,
            c = oi(a, s.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          r && (c = An(c, r));
          let d =
              ((g = e.eventStore),
          ...
          for (let r in l) {
            let o = l[r],
              ...
              p = c[o.defId],
              m = a[o.defId];
            if (!Hs(p.constraints, g, d, e.businessHours, t)) return !1;
            ...
            for (let e in h) {
              ...
              if (sr(g, n.range)) {
                ...
                if (y && !y(new Kr(t, u[n.defId], n), new Kr(t, m, o)))
                  return !1;
              }
            }
            let b = i.eventStore;
            for (let e of p.allows) {
              let i,
                ...
                a = b.defs[m.defId],
                l = b.instances[r];
              if (((i = a ? new Kr(t, a, l) : new Kr(t, m)), !e(qr(s, t), i)))
                return !1;
            }
          }
          return !0;
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          r && (c = r(c));
          if (!Hs(c.constraints, l, i, e.businessHours, t)) return !1;
          ...
          for (let e in o) {
            ...
            if (sr(l, n.range)) {
              ...
              if (u && !u(new Kr(t, s[n.defId], n), null)) return !1;
            }
          }
          for (let e of c.allows) {
            let r = Object.assign(Object.assign({}, n), a);
            if (!e(qr(r, t), null)) return !1;
          }
          return !0;
        })(e, t, n, r)
      )
  ...
  function Hs(e, t, n, r, i) {
    for (let s of e) if (!zs(Bs(s, t, n, r, i), t)) return !1;
    return !0;
  }
  ...
  const Us = /^(visible|hidden)$/;
  class Ls extends Vn {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
          (this.el = e), Gn(this.props.elRef, e);
        });
    }
    render() {
      let { props: e } = this,
  ...
  class Ws {
    ...
    collect(e, t, n) {
      return Tn(this.currentMap, e, t, n);
    }
    getAll() {
  ...
  function Gs(e, t) {
    return null != t.maxHeight || Vs(e, t);
  }
  function Qs(e, t, n, r) {
    let { expandRows: i } = n;
    ...
    for (let r of e) {
      ...
      for (let i = 0; i < e; i += 1)
        n.push(
          p("col", {
            style: {
              width: "shrink" === r.width ? Zs(t) : r.width || "",
              minWidth: r.minWidth || "",
            },
          })
        );
  ...
  class no extends Vn {
    constructor() {
      super(...arguments),
        (this.processCols = Gt((e) => e, qs)),
        (this.renderMicroColGroup = Gt(Ys)),
        (this.scrollerRefs = new Ws()),
        (this.scrollerElRefs = new Ws(this._handleScrollerEl.bind(this))),
        (this.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
      ...
      return "outerContent" in e
        ...
        : p(
            "tr",
            {
              key: e.key,
              role: "presentation",
              className: Js(e, this.props.liquid).join(" "),
            },
    ...
    computeShrinkWidth() {
      return Xs(this.props.cols) ? Fs(this.scrollerElRefs.getAll()) : 0;
    }
    computeScrollerDims() {
      let e = $i(),
  ...
  no.addStateEquality({ scrollerClientWidths: Cn, scrollerClientHeights: Cn });
  class ro extends Vn {
    constructor() {
      super(...arguments),
        (this.buildPublicEvent = Gt((e, t, n) => new Kr(e, t, n))),
        (this.handleEl = (e) => {
          (this.el = e), Gn(this.props.elRef, e), e && ii(e, this.props.seg);
        });
    }
    render() {
      const { props: e, context: t } = this,
        ...
        o = {
          ...
          isDraggable: !e.disableDragging && di(r, t),
          isStartResizable: !e.disableResizing && ui(r, t),
          isEndResizable: !e.disableResizing && hi(r),
  ...
  class lo extends Vn {
    constructor() {
      super(...arguments), (this.refineRenderProps = Qt(uo));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
  ...
  function co(e) {
    return Boolean(e.dayCellContent || qn("dayCellContent", e));
  }
  function uo(e) {
    let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e,
      s = Fi(t, e.todayRange, null, r),
      o = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : ao) : "";
    return Object.assign(
  ...
  class vo extends Vn {
    constructor() {
      super(...arguments),
        ...
        (this.handleRootEl = (e) => {
          (this.rootEl = e), this.props.elRef && Gn(this.props.elRef, e);
        }),
  ...
  class bo extends Vn {
    constructor() {
      super(...arguments),
        ...
        (this.handleLinkEl = (e) => {
          (this.linkEl = e), this.props.elRef && Gn(this.props.elRef, e);
        }),
        (this.handleClick = (e) => {
          ...
          Boolean(e.moreCnt) &&
            p(
              $n,
              {
                ...
                defaultGenerator: e.defaultGenerator || Eo,
  ...
  function So(e) {
    ...
    let { hiddenSegs: t } = e;
    return { start: Ao(t), end: ((n = t), n.reduce(wo).eventRange.range.end) };
    var n;
  }
  function Ao(e) {
    return e.reduce(Do).eventRange.range.start;
  }
  function Do(e, t) {
  ...
  var Co = {
      ...
      EventImpl: Kr,
      Interaction: Ti,
      MoreLinkContainer: bo,
      NamedTimeZoneImpl: class {
        constructor(e) {
          this.timeZoneName = e;
        }
      },
      NowIndicatorContainer: oo,
      NowTimer: Ii,
      PositionCache: rs,
      RefMap: Ws,
      ScrollController: ss,
      ...
      computeInnerRect: es,
      computeRect: ts,
      computeShrinkWidth: Fs,
      computeVisibleDayRange: cr,
      config: vs,
      constrainPoint: Bi,
      createDuration: ft,
      createEmptyEventStore: Rr,
      createEventInstance: fr,
      createEventUi: Ir,
      createFormatter: an,
      diffDates: ur,
      diffDayAndTime: _t,
      ...
      getCanVGrowWithinCell: xi,
      getClippingParents: ns,
      getDateMeta: Fi,
      getDayClassNames: Vi,
      getDefaultEventEnd: Yr,
      getElSeg: si,
      getEntrySpanEnd: ds,
      getEventTargetViaRoot: ze,
      getIsRtlScrollbarOnLeft: Xi,
      getRectCenter: ji,
      getRelevantEvents: Cr,
      getScrollGridClassNames: $s,
      getScrollbarWidths: $i,
      getSectionClassNames: Js,
      getSectionHasLiquidHeight: Vs,
      getSegAnchorAttrs: vi,
      getSegMeta: gi,
      ...
      getStickyFooterScrollbar: to,
      getStickyHeaderDates: eo,
      getUniqueDomId: Le,
      greatestDurationDenominator: Et,
      groupIntersectingEntries: hs,
      guid: Ze,
      hasBgRendering: ri,
      hasCustomDayCellContent: co,
      hasShrinkWidth: Xs,
      identity: yn,
      injectStyles: xe,
      interactionSettingsStore: Mi,
      interactionSettingsToStore: ki,
      intersectRanges: rr,
      intersectRects: Hi,
      intersectSpans: fs,
      isArraysEqual: St,
      isColPropsEqual: qs,
      isDateSelectionValid: Os,
      isDateSpansEqual: Ei,
      isInt: ct,
      isInteractionValid: Is,
      isMultiDayRange: dr,
      isPropsEqual: Cn,
      isPropsValid: Ps,
      isValidDate: jt,
      ...
      renderFill: go,
      renderMicroColGroup: Ys,
      renderScrollShim: Ks,
      requestJson: Ci,
      sanitizeShrinkWidth: Zs,
      setRef: Gn,
      sliceEventStore: ni,
      sortEventSegs: li,
      startOfDay: Mt,
  ...
  const xo = [],
    ...
    To = Object.assign(Object.assign({}, _o), {
      buttonHints: {
        prev: "Previous $0",
        next: "Next $0",
  ...
  function zo(e) {
    ...
    return (
      t.content
        ? (n = Uo(t))
        : !n ||
          n.prototype instanceof Vn ||
          (n = Uo(Object.assign(Object.assign({}, t), { content: n }))),
  ...
  (Ho.prototype.classes = {
    ...
    (Ho.prototype.baseIconClass = "fc-icon"),
    (Ho.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (Ho.prototype.rtlIconClasses = {
      prev: "fc-icon-chevron-right",
      next: "fc-icon-chevron-left",
      prevYear: "fc-icon-chevrons-right",
      nextYear: "fc-icon-chevrons-left",
    }),
    (Ho.prototype.iconOverrideOption = "buttonIcons"),
    (Ho.prototype.iconOverrideCustomButtonOption = "icon"),
    (Ho.prototype.iconOverridePrefix = "fc-icon-");
  let Wo = {};
  function Fo(e, t, n) {
  ...
  function Vo(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return Yo(
          e,
          t.sourceIds ? Dn(t.sourceIds) : Xo(e, r),
          i,
          t.isRefetch || !1,
          r
        );
  ...
  function Qo(e, t, n, r) {
    ...
    return n && (i = qo(i, n, r)), Object.assign(Object.assign({}, e), i);
  }
  function qo(e, t, n) {
    return Yo(
      e,
      Sn(e, (e) =>
        (function (e, t, n) {
          if (!$o(e, n)) return !e.latestFetchId;
          return (
  ...
  function na(e, t, n, r, i) {
    return {
      header: e.headerToolbar ? ra(e.headerToolbar, e, t, n, r, i) : null,
      footer: e.footerToolbar ? ra(e.footerToolbar, e, t, n, r, i) : null,
    };
  }
  ...
  const aa = [
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            Di(
              e.eventSource.meta.bind(null, Si(e.range, r)),
              (e) => t({ rawEvents: e }),
              n
            );
          },
    ...
    Oo({
      name: "misc",
      isLoadingFuncs: [(e) => Go(e.eventSources)],
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            Object.assign(Object.assign({}, Si(e.activeRange, t.dateEnv)), {
              view: t.viewApi,
            })
          );
        },
        eventStore: function (e, t) {
          let { emitter: n } = t;
          n.hasHandlers("eventsSet") && n.trigger("eventsSet", ti(e, t));
        },
      },
    }),
  ];
  ...
  class da {
    ...
    handleInput(e, t) {
      ...
      if (
        ...
        for (const e of this.resetListeners.values()) e();
    }
    getDateMarker() {
  ...
  class ua {
    constructor(e) {
      (this.computeCurrentViewData = Gt(this._computeCurrentViewData)),
        (this.organizeRawLocales = Gt(ko)),
        (this.buildLocale = Gt(Mo)),
        (this.buildPluginHooks = No()),
        (this.buildDateEnv = Gt(ha)),
        (this.buildTheme = Gt(fa)),
        (this.parseToolbars = Gt(na)),
        (this.buildViewSpecs = Gt(Lo)),
        (this.buildDateProfileGenerator = Qt(ga)),
        (this.buildViewApi = Gt(pa)),
        (this.buildViewUiProps = Qt(ya)),
        (this.buildEventUiBySource = Gt(ma, Cn)),
        (this.buildEventUiBases = Gt(va)),
        (this.parseContextBusinessHours = Qt(Ea)),
        (this.buildTitle = Gt(ca)),
        (this.nowManager = new da()),
        (this.emitter = new Fr()),
        (this.actionRunner = new la(
      ...
      ar(a.activeRange, o) || (o = a.currentRange.start);
      for (let e of n.pluginHooks.contextInit) e(s);
      let l = Fo(n.calendarOptions, a, s),
        c = {
      ...
      ba(c, s) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
    ...
    _handleAction(e) {
      ...
      let u = Vo(n.eventSources, e, d, l),
        h = jr(n.eventStore, e, u, d, l),
        f =
          (Go(u) &&
        ...
        v = {
          ...
          dateSelection: Jo(n.dateSelection, e),
          eventSelection: Ko(n.eventSelection, e),
          eventDrag: ea(n.eventDrag, e),
          eventResize: ta(n.eventResize, e),
        },
      ...
      if (a && a !== l) {
        a.timeZone !== l.timeZone &&
          ((t.eventSources = s.eventSources =
            (function (e, t, n) {
              let r = t ? t.activeRange : null;
              return Yo(e, Xo(e, n), r, !0, n);
            })(s.eventSources, t.dateProfile, s)),
          (t.eventStore = s.eventStore =
            Lr(s.eventStore, n.dateEnv, s.dateEnv)),
          (t.renderableEventStore = s.renderableEventStore =
            Lr(s.renderableEventStore, n.dateEnv, s.dateEnv)));
        for (let e in o)
    ...
    processRawCalendarOptions(e, t) {
      let { locales: n, locale: r } = mn([cn, e, t]),
        ...
        a = this.buildPluginHooks(e.plugins || [], aa),
        l = (this.currentCalendarOptionsRefiners = Object.assign(
          Object.assign(
            Object.assign(Object.assign(Object.assign({}, ln), dn), un),
            a.listenerRefiners
          ),
          a.optionRefiners
        )),
      ...
      for (let e in d)
        ...
        (d[e] === h[e] || (hn[e] && e in h && hn[e](h[e], d[e])))
          ? (u[e] = f[e])
          : l[e]
          ? ((u[e] = l[e](d[e])), (g = !0))
          : (c[e] = h[e]);
      ...
      for (let e in s)
        s[e] === l[e] || (hn[e] && hn[e](s[e], l[e]))
          ...
          : (s[e] === this.currentCalendarOptionsInput[e] ||
            (hn[e] && hn[e](s[e], this.currentCalendarOptionsInput[e]))
  ...
  function ha(e, t, n, r, i, s, o, a) {
    let l = Mo(t || o.defaultCode, o.map);
    return new Pn({
  ...
  function fa(e, t) {
    return new (t.themeClasses[e.themeSystem] || Ho)(e);
  }
  function ga(e) {
  ...
  function Ea(e) {
    return Gr(e.options.businessHours, e);
  }
  function Sa(e, t) {
    for (let n in e)
          ...
          i && d.push(n.getClass("buttonActive")),
            r.push(
              p(
                ...
                a || (l ? p("span", { className: l, role: "img" }) : "")
              )
            );
        }
      }
  ...
  class wa extends Vn {
    constructor() {
      super(...arguments),
        ...
        (this.handleEl = (e) => {
          (this.el = e), Gn(this.props.elRef, e), this.updateAvailableWidth();
        }),
        (this.handleResize = () => {
        ...
        (this.handleSegClick = (e, t) => {
          ...
          if (i && n.isValidSegDownEl(e.target)) {
            ...
            r.emitter.trigger("eventClick", {
              el: t,
              event: new Kr(n.context, i.eventRange.def, i.eventRange.instance),
              jsEvent: e,
              view: r.viewApi,
            }),
  ...
  class Ra extends Ti {
    ...
    triggerEvent(e, t, n) {
      ...
      (t && !r.isValidSegDownEl(t.target)) ||
        i.emitter.trigger(e, {
          el: n,
          event: new Kr(i, s.eventRange.def, s.eventRange.instance),
          jsEvent: t,
          view: i.viewApi,
        });
    }
  ...
  class xa extends Fn {
    constructor() {
      super(...arguments),
        (this.buildViewContext = Gt(Wn)),
        (this.buildViewPropTransformers = Gt(Ta)),
        (this.buildToolbarProps = Gt(_a)),
      ...
      return p(
        ...
        p(Ii, { unit: "day" }, (r) => {
          ...
          return p(
            ...
            p(
              wa,
              { liquid: i, height: s, aspectRatio: e, labeledById: a },
              this.renderView(t),
  ...
  function ka(e) {
    let t = Mo(e.locale || "en", ko([]).map);
    return new Pn(
      Object.assign(
        Object.assign({ timeZone: cn.timeZone, calendarSystem: "gregory" }, e),
        { locale: t }
      )
    );
  }
  ...
  class Na {
    constructor(e) {
      (this.subjectEl = null),
        ...
        (Ia += 1),
        1 === Ia && window.addEventListener("touchmove", Pa, { passive: !1 });
    }
    destroy() {
      this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
        ...
        (Ia -= 1),
        Ia || window.removeEventListener("touchmove", Pa, { passive: !1 });
    }
    tryStart(e) {
      let t = this.querySubjectEl(e),
        n = e.target;
      return (
        !(!t || (this.handleSelector && !Oe(n, this.handleSelector))) &&
        ((this.subjectEl = t),
        (this.isDragging = !0),
        (this.wasTouchScroll = !1),
        !0)
  ...
  const Ua = "function" == typeof performance ? performance.now : Date.now;
  class La {
    constructor() {
      (this.isEnabled = !0),
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(Ua()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Fa {
    constructor(e) {
      (this.el = e),
        (this.origRect = ts(e)),
        (this.scrollCaches = ns(e).map((e) => new ja(e, !0)));
    }
    destroy() {
      for (let e of this.scrollCaches) e.destroy();
    }
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!Va(e.getEventTarget()) && !Pi(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function Va(e) {
  ...
  class Ga {
    ...
    prepareHits() {
      this.offsetTrackers = An(
        this.droppableStore,
        (e) => (e.component.prepareHits(), new Fa(e.el))
      );
    }
    releaseHits() {
  ...
  function Qa(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && Ei(e.dateSpan, t.dateSpan))
    );
  }
  function qa(e, t) {
    let n = {};
    ...
    constructor(e) {
      super(e),
        ...
        (this.handlePointerDown = (e) => {
          ...
          let a = (this.subjectSeg = si(e.subjectEl)),
            l = (this.eventRange = a.eventRange).instance.instanceId;
          (this.relevantEvents = Cr(o.getCurrentData().eventStore, l)),
          ...
          if (e) {
            ...
            i === s || (t.editable && t.droppable)
              ? ((o = (function (e, t, n, r) {
                ...
                o &&
                  ((a = Zr(n, s.getCurrentData().eventUiBases, o, s)),
                  (c.mutatedEvents = a),
                  Is(c, e.dateProfile, s) ||
                    ((l = !0),
                    (o = null),
                    (a = null),
            ...
            if (
              ...
              if (r === t) {
                ...
                r.emitter.trigger("eventAdd", g),
                  ...
                  r.emitter.trigger(
                    "drop",
                    Object.assign(Object.assign({}, qa(d.dateSpan, r)), {
                      draggedEl: e.subjectEl,
                      jsEvent: e.origEvent,
      ...
      let { component: t } = this,
        { options: n } = t.context,
        r = (this.dragging = new Wa(e.el));
      (r.pointer.selector = Ya.SELECTOR),
        (r.touchScrollAllowed = !1),
        (r.autoScroller.isEnabled = n.dragScroll);
      let i = (this.hitDragging = new Ga(this.dragging, Mi));
  ...
  Ya.SELECTOR = ".fc-event-draggable, .fc-event-resizable";
  const Za = { fixedMirrorParent: yn },
    Xa = {
      dateClick: yn,
      eventDragStart: yn,
      eventDragStop: yn,
  ...
  class $a {
    constructor(e, t) {
            ...
            this.canDropElOnCalendar(n.subjectEl, i) &&
              ((s = (function (e, t, n) {
                ...
                let l = t.duration
                    ...
                    : Yr(e.allDay, a, n),
                  c = fr(o.defId, { start: a, end: l });
                return { def: o, instance: c };
              })(e.dateSpan, this.dragMeta, i)),
              (a.mutatedEvents = wr(s)),
              (o = !Is(a, e.dateProfile, i)),
              o &&
        ...
        (this.handleDragEnd = (e) => {
          ...
          if ((this.clearDrag(), t && n)) {
            ...
            if (
              (t.emitter.trigger(
                "drop",
                Object.assign(Object.assign({}, qa(r.dateSpan, t)), {
                  draggedEl: e.subjectEl,
                  jsEvent: e.origEvent,
                  view: i,
                })
      ...
      let n = (this.hitDragging = new Ga(e, Mi));
      (n.requireInitial = !1),
          ...
          super(e),
            ...
            (this.handleDragEnd = (e) => {
              ...
              if (!n.wasTouchScroll) {
                ...
                if (n && r && Qa(n, r)) {
                  let { context: r } = t,
                    i = Object.assign(Object.assign({}, qa(n.dateSpan, r)), {
                      dayEl: n.dayEl,
                      jsEvent: e.origEvent,
            ...
            (this.dragging = new Wa(e.el)),
            (this.dragging.autoScroller.isEnabled = !1);
          let t = (this.hitDragging = new Ga(this.dragging, ki(e)));
          t.emitter.on("pointerdown", this.handlePointerDown),
      ...
      class extends Ti {
        constructor(e) {
          super(e),
            ...
            (this.handleHitUpdate = (e, t) => {
              ...
              if (e) {
                ...
                (e.componentId === t.componentId &&
                  ...
                  (r && Os(r, e.dateProfile, n)) || ((i = !0), (r = null));
              }
              r
            ...
            (this.handlePointerUp = (e) => {
              this.dragSelection &&
                (Qr(this.dragSelection, e, this.component.context),
                (this.dragSelection = null));
            });
          let { component: t } = e,
            { options: n } = t.context,
          ...
          (r.touchScrollAllowed = !1),
            ...
            (r.autoScroller.isEnabled = n.dragScroll);
          let i = (this.hitDragging = new Ga(this.dragging, ki(e)));
          i.emitter.on("pointerdown", this.handlePointerDown),
            i.emitter.on("dragstart", this.handleDragStart),
            i.emitter.on("hitupdate", this.handleHitUpdate),
            i.emitter.on("pointerup", this.handlePointerUp);
        ...
        constructor(e) {
          super(e),
            ...
            (this.handleHitUpdate = (e, t, n) => {
              ...
              a &&
                ((l = Zr(i, r.getCurrentData().eventUiBases, a, r)),
                (d.mutatedEvents = l),
                Is(d, e.dateProfile, r) ||
    ...
    calendarInteractions: [
      class {
        constructor(e) {
          (this.context = e),
            ...
            (this.onDocumentPointerDown = (e) => {
              ...
              (this.matchesCancel = !!Oe(n, t)),
                (this.matchesEvent = !!Oe(n, Ya.SELECTOR));
            }),
          ...
          let t = (this.documentPointer = new Na(document));
  ...
  class el extends ls {
    ...
    renderHScrollLayout(e, t, n, r) {
      ...
      let { props: s, context: o } = this,
        a = !s.forPrint && eo(o.options),
        l = !s.forPrint && to(o.options),
        c = [];
      return (
        e &&
          c.push({
  ...
  class al extends Vn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r } = e,
        i = fi(r, n.eventTimeFormat || il, t, !0, e.defaultDisplayEventEnd);
      return p(
        ro,
        Object.assign({}, e, {
          elTag: "a",
  ...
  class hl extends ls {
    constructor() {
      super(...arguments),
        ...
        (this.handleRootEl = (e) => {
          Gn(this.rootElRef, e), Gn(this.props.elRef, e);
        });
    }
    render() {
      ...
      return p(
        ...
        (s, a) =>
          p(
            ...
            !a.isDisabled && (t.showDayNumber || co(i) || t.forceDayTop)
              ? p(
                  "div",
  ...
  function ml(e, t, n, r, i, s, o) {
    ...
    for (let t = 0; t < e.length; t += 1) {
      let n = e[t],
        r = pl(n);
      null != i[r]
        ? l.push({ index: t, span: { start: n.firstCol, end: n.lastCol + 1 } })
        : c.push(n);
    }
    let d = a.addSegs(l),
      u = a.toRects(),
  ...
  function vl(e, t, n, r) {
    ...
    let i = e.eventRange,
      s = i.range,
      o = rr(s, { start: r[t].date, end: wt(r[n - 1].date, 1) });
    return Object.assign(Object.assign({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
  ...
  class bl extends ls {
    constructor() {
      super(...arguments),
        (this.cellElRefs = new Ws()),
        (this.frameElRefs = new Ws()),
        (this.fgElRefs = new Ws()),
        (this.segHarnessRefs = new Ws()),
        (this.rootElRef = { current: null }),
        (this.state = {
          framePositions: null,
        ...
        for (let o of e) {
          ...
          s.push(
            p(
              ...
              "bg-event" === t
                ? p(ho, Object.assign({ seg: o }, gi(o, r)))
                : go(t)
            )
          );
        }
        ...
        if (e) {
          ...
          if (e.length) {
            ...
            (n.framePositions && n.framePositions.similarTo(r)) ||
              this.setState({ framePositions: new rs(t, e, !0, !1) });
          }
        }
  ...
  class El extends ls {
    constructor() {
      super(...arguments),
        (this.splitBusinessHourSegs = Gt(tl)),
        (this.splitBgEventSegs = Gt(Sl)),
        (this.splitFgEventSegs = Gt(tl)),
        (this.splitDateSelectionSegs = Gt(tl)),
        (this.splitEventDrag = Gt(rl)),
        (this.splitEventResize = Gt(rl)),
        (this.rowRefs = new Ws());
    }
    render() {
      let { props: e, context: t } = this,
      ...
      if (this.needsScrollReset && this.props.clientWidth) {
        const e = (function (e, t) {
          ...
          t.currentRangeUnit.match(/year|month/) &&
            (n = e.querySelector(`[data-date="${Wt(t.currentDate)}-01"]`));
  ...
  function Rl(e, t) {
    let n = new _s(e.renderRange, t);
    return new Ts(n, /year|month|week/.test(e.currentRangeUnit));
  }
  class xl extends hr {
    buildRenderRange(e, t, n) {
  ...
  class kl extends Li {
    ...
    getKeysForEventDef(e) {
      return e.allDay ? (ri(e) ? ["timed", "allDay"] : ["allDay"]) : ["timed"];
    }
  }
  const Ml = an({
    hour: "numeric",
      ...
      let { dateEnv: r, options: i, viewApi: s } = n,
        o =
          null == i.slotLabelFormat
            ...
            ? an(i.slotLabelFormat[0])
            : an(i.slotLabelFormat),
        a = {
          level: 0,
          time: e.time,
  ...
  class Nl extends Vn {
    render() {
      return this.props.slatMetas.map((e) =>
        p("tr", { key: e.key }, p(Il, Object.assign({}, e)))
      );
    }
  }
  ...
  class Hl extends ls {
      ...
      super(...arguments),
        ...
        (this.renderHeadAxis = (e, t = "") => {
          let { options: n } = this.context,
            ...
            i = r.renderRange,
            s =
              1 === xt(i.start, i.end) ? qi(this.context, i.start, "week") : {};
    ...
    renderHScrollLayout(e, t, n, r, i, s, o) {
      ...
      let { context: l, props: c } = this,
        d = !c.forPrint && eo(l.options),
        u = !c.forPrint && to(l.options),
        h = [];
      e &&
        h.push({
          type: "header",
              ...
              content: (e) =>
                p(
                  ...
                  p(
                    ...
                    e.tableColGroupNode,
                    p("tbody", null, p(Nl, { slatMetas: s }))
                  ),
                  p(
                    "div",
                    { className: "fc-timegrid-now-indicator-container" },
                    p(Ii, { unit: f ? "minute" : "day" }, (e) => {
  ...
  class jl {
    ...
    computeDateTop(e, t) {
      return (
        t || (t = Mt(e)), this.computeTimeTop(ft(e.valueOf() - t.valueOf()))
      );
    }
    computeTimeTop(e) {
      let t,
  ...
  class Kl extends Vn {
    constructor() {
      super(...arguments), (this.sortEventSegs = Gt(li));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return p(
        ...
        (t) =>
          p(
            ...
            co(n) && p(t, { elTag: "div", elClasses: ["fc-timegrid-col-misc"] })
          )
      );
    }
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = Xl(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
          (r, i) => {
            let s = e[i];
            return p(
              "div",
              ...
              "bg-event" === t
                ? p(
                    ho,
                    Object.assign({ seg: s }, gi(s, n.todayRange, n.nowDate))
                  )
                : go(t)
            );
          }
  ...
  class oc extends ls {
    ...
    render() {
      ...
      return p(Ii, { unit: i ? "minute" : "day" }, (a, l) =>
        p(
          rc,
          Object.assign(
      ...
      l =
        ...
        (function (e) {
          ...
          for (t = lc.length - 1; t >= 0; t -= 1)
            if (((n = ft(lc[t])), (r = bt(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
            ...
            (function (e, t, n, r, i) {
              ...
              if (!1 !== s.displayEventTime) {
                ...
                if (
                  (a.allDay
                    ? (c = !0)
                    : dr(e.eventRange.range)
                    ? e.isStart
                      ? (o = fi(e, t, n, null, null, l.range.start, e.end))
                      : e.isEnd
                      ? (o = fi(e, t, n, null, null, e.start, l.range.end))
                      : (c = !0)
                    : (o = fi(e, t, n)),
                  c)
                ) {
  ...
  function yc(e) {
    let t = Mt(e.renderRange.start),
      ...
      i = [];
    for (; t < n; )
      r.push(t), i.push({ start: t, end: wt(t, 1) }), (t = wt(t, 1));
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Lt(t[n]),
                    u = o + "-" + a;
                  c.push(
                    p(hc, { key: a, cellId: u, dayDate: t[n], todayRange: l })
                  ),
                    (d = li(d, r.eventOrder));
                  for (let t of d)
                    c.push(
  ...
  function Dc(e, t, n, r, i) {
    ...
    for (; a.valueOf() < o.valueOf(); ) {
      ...
      const d = t.activeRange ? rr(t.activeRange, i ? c : o) : null;
      l.push({
    ...
    (e.Draggable = class {
      constructor(e, t = {}) {
        (this.handlePointerDown = (e) => {
          ...
          (t.minDistance =
            null != n ? n : e.isTouch ? 0 : cn.eventDragMinDistance),
    ...
    (e.ThirdPartyDraggable = class {
      constructor(e, t) {
        ...
        "string" == typeof t.itemSelector
          ...
          (new $a(r, t.eventData).hitDragging.disablePointCheck = !0);
      }
      destroy() {
        this.dragging.destroy();
      }
