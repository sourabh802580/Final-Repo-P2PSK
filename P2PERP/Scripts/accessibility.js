!(
   ...
   */ (function (e, t) {
    "object" == typeof exports && "object" == typeof module
      ? (module.exports = t(
          e._Highcharts,
          e._Highcharts.Templating,
          e._Highcharts.AST,
          e._Highcharts.Legend,
          e._Highcharts.Axis,
          e._Highcharts.Color,
          e._Highcharts.SeriesRegistry,
          e._Highcharts.RendererRegistry,
          e._Highcharts.SVGRenderer,
          e._Highcharts.Point,
      ...
      ? (exports["highcharts/modules/accessibility"] = t(
          e._Highcharts,
          e._Highcharts.Templating,
          e._Highcharts.AST,
          e._Highcharts.Legend,
    ...
    (e, t, i, s, n, r, o, a, l, h, c) =>
      (() => {
        ...
        let { doc: E, win: A } = w(),
          { css: T } = w(),
          M = (A.EventTarget && new A.EventTarget()) || "none";
        function C(e) {
        ...
        !(function (e) {
          function t(e, t, i) {
            ...
            do
              (r = s(e, a)),
                (o = e.substring(a, r && r.begin - 1)).length &&
                  n.push({ value: o, type: "constant" }),
                r && n.push({ value: r.statement, type: "statement" }),
                (a = r ? r.end + 1 : a + 1);
            while (r);
            return (
              n.forEach((e) => {
                "statement" === e.type &&
                  (e.value = (function (e, t) {
                    let i,
                      ...
                      a = e.indexOf("]");
                    if (n > -1) {
                      let r = e.slice(n).indexOf(")") + n,
                        o = e.substring(0, n),
                        a = e.substring(r + 1),
                        l = e.substring(n + 6, r).split(","),
                        h = Number(l[1]),
                        c;
                      if (((s = ""), (i = B(l[0], t)))) {
                        c =
                    ...
                    if (r > -1) {
                      var l;
                      let i = e.slice(r).indexOf(")") + r,
                        n = e.substring(r + 8, i).split(",");
                      switch (Number(B(n[0], t))) {
                        case 0:
                          s = I(n[4], n[1]);
                          break;
                        case 1:
        ...
        let G = {
            ...
            getAxisRangeDescription: function (e) {
              ...
              return t.accessibility &&
                ...
                ? (function (e) {
                    ...
                    let o = i[r].toFixed(+("Seconds" !== r && "Minutes" !== r));
                    return t.langFormat("accessibility.axis.timeRange" + r, {
                      chart: t,
                      axis: e,
                      range: o.replace(".0", ""),
                    });
          ...
          W = class {
            ...
            createElement() {
              let e = K.createElement.apply(K, arguments);
          ...
          Y = class {
            ...
            addEvent() {
              ...
              return (
                this.eventRemovers.push({ element: arguments[0], remover: e }),
                e
              );
            }
            removeEvent(e) {
          ...
          { fireEventOnWrappedOrUnwrappedElement: j } = G,
          { getFakeMouseEvent: _ } = S,
          Z = class {
            destroy() {}
            ...
            run(e) {
              ...
              return (
                s
                  ? (i = s[1].call(this, t, e))
                  : 9 === t &&
                    (i = this.response[e.shiftKey ? "prev" : "next"]),
                i
              );
            }
          },
          { unhideChartElementFromAT: J, getChartTitle: ee } = G,
          { doc: et } = w(),
        ...
        !(function (e) {
          ...
          function n(e, i) {
            ...
            let s = this.getBBox(),
              n = er(e, 3),
              r = this.parentGroup,
              o = this.scaleX || (r && r.scaleX),
              a = this.scaleY || (r && r.scaleY),
              l = (o ? !a : a)
                ? Math.abs(o || a || 1)
            ...
            if ("text" === this.element.nodeName || g) {
              let e,
                ...
                a = +this.attr("y");
              if (
                (isNaN(o) || (c = o - s.width * r.x - n),
                isNaN(a) ||
                  (d =
                    a -
                    ("start" === this.attr("text-anchor") ? h : s.height) *
                      r.y -
                    n),
                g && i)
              ) {
                ...
                (u = p),
                  (p = e),
                  isNaN(o) || (c = o - s.height * r.x - n),
                  isNaN(a) || (d = a - s.width * r.y - n);
              }
            }
          ...
          e.compose = function (e, t) {
            ...
            o.renderFocusBorder ||
              ...
              a.addFocusBorder ||
                ((a.addFocusBorder = n), (a.removeFocusBorder = r));
          };
        })(p || (p = {}));
        let eo = p;
        var ea = x(660),
        ...
        function eb(e) {
          return (e.annotations || []).reduce(
            (e, t) => (
              t.options && !1 !== t.options.visible && (e = e.concat(t.labels)),
              e
            ),
            []
          );
        ...
        let ev = {
            ...
            getPointAnnotationTexts: function (e) {
              let t = eb(e.series.chart).filter(
                (t) => t.points.indexOf(e) > -1
              );
        ...
        let eL = class extends Z {
            ...
            updateScreenReaderSection(e) {
              let t = this.chart,
                ...
                s = i.buildContent(t),
                n = (i.element = i.element || this.createElement("div")),
                r = n.firstChild || this.createElement("div");
              s
                ? (this.setScreenReaderSectionAttribs(n, e),
                  el().setElementHTML(r, s),
                  n.appendChild(r),
                  i.insertIntoDOM(n, t),
                  t.styledMode ? eS(r, "highcharts-visually-hidden") : eB(r),
                  eM(t, r),
            ...
            defaultBeforeChartFormatter() {
              let e = this.chart,
                t =
                  e.options.accessibility.screenReaderSection.beforeChartFormat;
              if (!t) return "";
              let i = this.getAxesDescription(),
                ...
                n = "highcharts-a11y-sonify-data-btn-" + e.index,
                ...
                l = {
                  ...
                  playAsSoundButton: s ? this.getSonifyButtonText(n) : "",
                  viewTableButton: e.exporting?.getCSV
              ...
              return (
                (this.dataTableButtonId = r), (this.sonifyButtonId = n), eR(h)
              );
            }
            defaultAfterChartFormatter() {
              let e = this.chart,
                t =
                  e.options.accessibility.screenReaderSection.afterChartFormat;
              if (!t) return "";
                      ...
                      let o = t[0],
                        ...
                        l =
                          e.series && e.series.length < 2
                            ...
                            : "Multiple";
                      return (
                        (e.langFormat("accessibility.chartTypes." + o + l, r) ||
                          e.langFormat(
                            "accessibility.chartTypes.default" + l,
                            r
                          )) + (a ? " " + a : "")
                      );
                    })(e, e.types)
            ...
            getAxesDescription() {
              let e = this.chart,
                ...
                o = {};
              return (
                n && (o.xAxis = this.getAxisDescriptionText("xAxis")),
                r && (o.yAxis = this.getAxisDescriptionText("yAxis")),
                o
              );
            }
          ...
          { attr: eH } = w(),
          { getChartTitle: ez, unhideChartElementFromAT: eq } = G,
          { getFakeMouseEvent: eU } = S;
        function eG(e) {
        ...
        class eK extends Z {
          ...
          getKeyboardNavigation() {
            ...
            return new Q(t, {
              ...
              validate: function () {
                return (
                  !!t.exporting &&
                  t.options.exporting?.buttons?.contextButton.enabled !== !1 &&
                  !1 !== t.options.exporting.enabled &&
                  !1 !== (t.options.exporting.accessibility?.enabled || !1)
                );
              },
              init: function () {
                let e = i.exportButtonProxy,
                  s = i.chart.exporting?.group;
          ...
          onKbdNext(e) {
            ...
            for (
              ...
              e < (t.exporting?.divElements?.length || 0);
              ++e
            )
          ...
          onKbdClick(e) {
            let t = this.chart,
              i =
                void 0 !== t.highlightedExportItemIx &&
                t.exporting?.divElements?.[t.highlightedExportItemIx],
              s = eG(t)?.element;
            return (
              t.exporting?.openMenu
                ? i && this.fakeClickEvent(i)
                : (s && this.fakeClickEvent(s), t.highlightExportItem(0)),
              e.response.success
            );
          }
        }
        !(function (e) {
          ...
          function i() {
            ...
            e &&
              this.exporting?.contextMenuEl &&
              this.exporting?.openMenu &&
              (e.forEach((e) => {
                e &&
                  "highcharts-menu-item" === e.className &&
                  e.onmouseout &&
                  e.onmouseout(eU("mouseout"));
              }),
              (this.highlightedExportItemIx = 0),
              this.exporting.contextMenuEl.hideMenu(),
              this.container.focus());
          }
          function s(e) {
            let t = this.exporting?.divElements?.[e],
              i =
                void 0 !== this.highlightedExportItemIx &&
            ...
            if (t && "LI" === t.tagName && !(t.children && t.children.length)) {
              ...
              return (
                t.focus && s && t.focus(),
                i && i.onmouseout && i.onmouseout(eU("mouseout")),
                t.onmouseover && t.onmouseover(eU("mouseover")),
          ...
          e.compose = function (e) {
            ...
            r.hideExportMenu ||
              ((r.hideExportMenu = i),
              (r.highlightExportItem = s),
              (r.highlightLastExportItem = n),
              (r.showExportMenu = t));
          };
        })(eK || (eK = {}));
        let eV = eK,
          { doc: eW, win: eX } = w(),
          { addEvent: eY, defined: ej, fireEvent: e_ } = w(),
          { getElement: eZ, simulatedEventTarget: e$ } = S;
        class eQ {
          constructor(e, t) {
          ...
          updateExitAnchor() {
            let e = eZ(`highcharts-end-of-chart-marker-${this.chart.index}`);
            this.removeExitAnchor(),
              e
          ...
          onMouseUp(e) {
            if (
              ...
              !this.keyboardReset && e.relatedTarget !== e$)
            ) {
              let t = this.chart;
          ...
          updateContainerTabindex() {
            ...
            n.renderTo.hasAttribute("tabindex")
              ? (r.removeAttribute("tabindex"), (e = n.renderTo))
              : (e = r),
          ...
          e.compose = function (e) {
            ...
            return (
              !s.dismissPopupContent &&
                ((s.dismissPopupContent = t), eW && eY(eW, "keydown", i)),
              e
            );
          };
        })(eQ || (eQ = {}));
        ...
        class tr extends Z {
          ...
          proxyLegendItem(e) {
            let t = e.legendItem || {},
              i = e.legendItem?.label,
              s = i?.element,
              n = t.label?.styles?.textOverflow === "ellipsis";
            if (!t.label || !t.group) return;
            let r = this.chart.langFormat("accessibility.legend.legendItem", {
                chart: this.chart,
            ...
            n &&
              -1 !== (s.textContent || "").indexOf("…") &&
              (o.title = i?.textStr);
            let a = t.group.div ? t.label : t.group;
            e.a11yProxyElement = this.proxyProvider.addProxyElement(
              "legend",
              { click: t.label, visual: a.element },
              "button",
              o
            );
          }
            ...
            return new Q(i, {
              ...
              terminate: function () {
                (t.highlightedLegendItemIx = -1),
                  i.legend.allItems.forEach((e) => tn(!1, e));
              },
            });
          }
          onKbdArrowKey(e, t) {
            let {
              ...
              o = r.legend.allItems.length,
              a = r.options.accessibility.keyboardNavigation.wrapAround,
              l = t === i || t === s ? -1 : 1;
            return (
              r.highlightLegendItem(n + l)
                ? (this.highlightedLegendItemIx += l)
                : a &&
                  o > 1 &&
                  ((this.highlightedLegendItemIx = l > 0 ? 0 : o - 1),
                  r.highlightLegendItem(this.highlightedLegendItemIx)),
              e.response.success
            );
          }
          onKbdClick(e) {
        ...
        !(function (e) {
          function t(e) {
            ...
            if (s) {
              e6(i) && t[i] && tn(!1, t[i]);
              var r = this.legend;
              let o = (r.allItems[e].legendItem || {}).pageIx,
                a = r.currentPage;
              void 0 !== o && o + 1 !== a && r.scroll(1 + o - a);
              let l = n.label,
                h = s.a11yProxyElement && s.a11yProxyElement.innerElement;
              return (
                l && l.element && h && this.setFocusToElement(l, h),
                tn(!0, s),
                !0
              );
            }
          ...
          e.compose = function (e, s) {
            ...
            n.highlightLegendItem ||
              ((n.highlightLegendItem = t), e5(s, "afterColorizeItem", i));
          };
        })(tr || (tr = {}));
        let to = tr;
        var ta = x(532),
        ...
        function tm() {
          ...
          if (n) {
            ...
            let { scrollbarHeight: r, scrollButtonSize: o } = n;
            this.inverted
              ? ((n.left = n.opposite
                  ? this.chartWidth - r - n.height
                  : this.spacing[3] + r),
                (n.top = this.plotTop + o))
              : ((n.left = tu(t.left, this.plotLeft + o)),
                (n.top =
        ...
        function tP(e) {
          let t,
            ...
            a = s.rangeSelector,
            l = i.zooming.type;
          if (this.isXAxis && (n?.enabled || a?.enabled)) {
            if ("y" === l && "zoom" === e.trigger) t = !1;
            else if (
              (("zoom" === e.trigger && "xy" === l) || (tE && "xy" === o)) &&
              this.options.range
            ) {
              let t = r.previousZoom;
              tM(e.min)
                ? (r.previousZoom = [this.min, this.max])
                : t &&
                  ((e.min = t[0]), (e.max = t[1]), (r.previousZoom = void 0));
            }
          }
        ...
        class tD {
          ...
          toFixedRange(e, t, i, s) {
            let n = this.axis,
              r = (n.pointRange || 0) / 2,
              o = tk(i, n.translate(e, !0, !n.horiz)),
              a = tk(s, n.translate(t, !0, !n.horiz));
            return (
              tM(i) || (o = tT(o + r)),
              tM(s) || (a = tT(a - r)),
              (tC(o) && tC(a)) || (o = a = void 0),
              { min: o, max: a }
            );
          }
        }
        ...
        let { parse: tO } = tB(),
          ...
          { relativeLength: tG } = w(),
          tK = {
            "navigator-handle": function (e, t, i, s, n = {}) {
              let r = n.width ? n.width / 2 : i,
                o = tG(n.borderRadius || 0, Math.min(2 * r, s));
              return [
                ["M", -1.5, (s = n.height || s) / 2 - 3.5],
                ["L", -1.5, s / 2 + 4.5],
                ["M", 0.5, s / 2 - 3.5],
                ["L", 0.5, s / 2 + 4.5],
                ...tU.rect(-r - 1, 0.5, 2 * r + 1, s, { r: o }),
              ];
            },
          };
        var tV = x(608),
        ...
        let t1 = {
            compose: function (e, t, i) {
              tD.compose(t),
                tJ(tj, "Navigator") &&
                  ((e.prototype.setFixedRange = tZ),
                  tQ(t_().prototype.symbols, tK),
                  tQ(tY, { navigator: tL }),
                  t$(i, "afterUpdate", t0));
            },
          },
        ...
        !(function (e) {
          let t;
          function i(e) {
            let t = t6(e.options?.min, e.min),
              i = t6(e.options?.max, e.max);
            return {
              axisMin: t,
              axisMax: i,
              scrollMin: t4(e.dataMin)
                ? Math.min(t, e.min ?? 1 / 0, e.dataMin, e.threshold ?? 1 / 0)
                : t,
              scrollMax:
                e.treeGrid?.adjustedMax ??
                (t4(e.dataMax)
                  ? Math.max(
                      i,
                      e.max ?? -1 / 0,
          ...
          function n() {
            ...
            e.options?.scrollbar?.enabled &&
              ...
              t3(e.scrollbar, "changed", function (t) {
                let s,
                  n,
                  { axisMin: r, axisMax: o, scrollMin: a, scrollMax: l } = i(e),
                  h = e.toPixels(a),
                  c = e.toPixels(l) - h;
                if (t4(r) && t4(o))
                  if (
                    ((e.horiz && !e.reversed) || (!e.horiz && e.reversed)
                      ? ((s = Math.min(l, e.toValue(h + c * this.to))),
                        (n = Math.max(a, e.toValue(h + c * this.from))))
                      : ((s = Math.min(l, e.toValue(h + c * (1 - this.from)))),
                        (n = Math.max(a, e.toValue(h + c * (1 - this.to))))),
          ...
          function r() {
            let e,
              t,
              s,
              { scrollMin: n, scrollMax: r } = i(this),
              o = this.scrollbar,
              a = (this.axisTitleMargin || 0) + (this.titleOffset || 0),
            ...
            if (o && l) {
              ...
              if (
                ...
                isNaN(n) ||
                  ...
                  !t4(this.min) ||
                  !t4(this.max) ||
                  (t4(this.dataMin) && this.dataMin === this.dataMax))
              )
                o.setRange(0, 1);
                ...
                (t =
                  (this.toPixels(this.min) - this.toPixels(n)) /
                  (this.toPixels(r) - this.toPixels(n))),
                  (s =
                    (this.toPixels(this.max) - this.toPixels(n)) /
                    (this.toPixels(r) - this.toPixels(n))),
        ...
        class ig {
          static compose(e) {
            t8.compose(e, ig), iu(it, "Scrollbar") && il(ie, { scrollbar: t7 });
          }
          static swapXY(e, t) {
            return (
              t &&
          ...
          buttonToMaxClick(e) {
            let t = (this.to - this.from) * id(this.options.step, 0.2);
          ...
          buttonToMinClick(e) {
            let t = is(this.to - this.from) * id(this.options.step, 0.2);
            this.updatePosition(is(this.from - t), is(this.to - t)),
              ih(this, "changed", {
                from: this.from,
                to: this.to,
                trigger: "scrollbar",
          ...
          destroy() {
            ...
            e.removeEvents(),
              ...
              t &&
                e === t.scrollbar &&
                ((t.scrollbar = null), ia(t.scrollbarButtons));
          }
          drawScrollbarButton(e) {
            let t = this.renderer,
              ...
              s = this.options,
              n = this.size,
              r = t.g().add(this.group);
            if ((i.push(r), s.buttonsEnabled)) {
              let o = t.rect().addClass("highcharts-scrollbar-button").add(r);
              this.chart.styledMode ||
                o.attr({
          ...
          init(e, t, i) {
            (this.scrollbarButtons = []),
              (this.renderer = e),
              (this.userOptions = t),
              (this.options = ic(t7, ie.scrollbar, t)),
              (this.options.margin = id(this.options.margin, 10)),
              (this.chart = i),
              (this.size = id(this.options.size, this.options.height)),
          ...
          mouseMoveHandler(e) {
            let t,
              i = this.chart.pointer?.normalize(e) || e,
          ...
          render() {
            ...
            this.track.attr({ x: -ir(0, r), y: -ir(0, r) }),
              ...
              this.scrollbarGroup.translate(
                -ir(0, this.scrollbarStrokeWidth),
                -ir(0, this.scrollbarStrokeWidth)
              ),
        ...
        var im = x(540),
          ib = x.n(im);
        let { defaultOptions: ix } = w(),
          { isTouchDevice: iy } = w(),
          {
            prototype: { symbols: iv },
          } = ib(),
          {
            addEvent: iw,
            clamp: iE,
        ...
        class iL {
          ...
          drawMasks(e, t, i, s) {
            ...
            i
              ...
              this.shades.forEach((e, t) => {
                e[s]({ x: o[t], y: a[t], width: r[t], height: n[t] });
              });
          }
          renderElements() {
            let e = this,
              ...
              n = s.inverted,
              r = s.renderer,
              o = { cursor: n ? "ns-resize" : "ew-resize" },
              a =
                e.navigatorGroup ??
                (e.navigatorGroup = r
                  .g("navigator")
              ...
              [0, 1].forEach((t) => {
                ...
                if (e.handles[t] && e.handles[t].symbolUrl === h) {
                  if (!e.handles[t].isImg && e.handles[t].symbolName !== h) {
                    let i = iv[h].call(iv, -l / 2 - 1, 0, l, n);
                    e.handles[t].attr({ d: i }), (e.handles[t].symbolName = h);
                  }
                } else
                  e.handles[t]?.destroy(),
                    (e.handles[t] = r.symbol(h, -l / 2 - 1, 0, l, n, i)),
                    e.handles[t]
                      .attr({ zIndex: 7 - t })
                      .addClass(
            ...
            if (
              ...
              !1 === e.adaptToUpdatedData &&
                this.baseSeries.forEach((e) => {
                  iF(e, "updatedData", this.updatedDataHandler);
                }, this),
              e.adaptToUpdatedData &&
                this.baseSeries.forEach((e) => {
                  e.eventsToUnbind.push(
                    iw(e, "updatedData", this.updatedDataHandler)
                  );
                }, this),
          ...
          render(e, t, i, s) {
            let n = this.chart,
              r = this.xAxis,
              o = r.pointRange || 0,
              a = r.navigatorAxis.fake ? n.xAxis[0] : r,
              ...
              x,
              y;
            if (this.hasDragged && !iT(i)) return;
            if (
              ...
              if (!h) return;
              else (i = 0), (s = iI(r.width, a.width));
            this.left = iI(r.left, n.plotLeft + p + (c ? n.plotWidth : 0));
            let v =
              (this.size =
              x =
                iI(r.len, (c ? n.plotHeight : n.plotWidth) - 2 * p));
            (g = c ? f : x + 2 * p),
              (i = iI(i, r.toPixels(e, !0))),
              (s = iI(s, r.toPixels(t, !0))),
              (iN(i) && Math.abs(i) !== 1 / 0) || ((i = 0), (s = g));
            let w = r.toValue(i, !0),
              E = r.toValue(s, !0),
              A = Math.abs(iA(E - w));
            A < d
              ? this.grabbedLeft
                ? (i = r.toPixels(E - d - o, !0))
                : this.grabbedRight && (s = r.toPixels(w + d + o, !0))
              : iT(u) &&
                iA(A - o) > u &&
                (this.grabbedLeft
                  ? (i = r.toPixels(E - u - o, !0))
                  : this.grabbedRight && (s = r.toPixels(w + u + o, !0))),
              (this.zoomedMax = iE(Math.max(i, s), 0, v)),
              (this.zoomedMin = iE(
                this.fixedWidth
          ...
          addMouseEvents() {
            ...
            (e.mouseMoveHandler = n =
              ...
              (s = e.getPartsEvents("mousedown")).push(
                iw(t.renderTo, "mousemove", n),
                iw(i.ownerDocument, "mouseup", r),
                iw(t.renderTo, "touchmove", n),
                iw(i.ownerDocument, "touchend", r)
              ),
              ...
              e.series &&
                e.series[0] &&
                s.push(
                  iw(e.series[0].xAxis, "foundExtremes", function () {
          ...
          getPartsEvents(e) {
            ...
            return (
              ["shades", "handles"].forEach(function (s) {
                t[s].forEach(function (n, r) {
                  i.push(
                    iw(n.element, e, function (e) {
                      t[s + "Mousedown"](e, r);
                    })
                  );
                });
              ...
              1 === t
                ...
                : ((u = l - a - o / 2),
                  ...
                  u !== n &&
                    ((this.fixedWidth = o),
                    iT(
                      (d = s.navigatorAxis.toFixedRange(u, u + o, c, h)).min
                    ) &&
                      iP(this, "setRange", {
          ...
          onMouseMove(e) {
            ...
            (!e.touches || 0 !== e.touches[0].pageX) &&
              ...
              t.grabbedLeft
                ...
                : t.grabbedCenter &&
                  ((t.hasDragged = !0),
                  l < r ? (l = r) : l > s + r - n && (l = s + r - n),
                  t.render(0, 0, l - r, l - r + n)),
              t.hasDragged &&
                t.scrollbar &&
                iI(
                  t.scrollbar.options.liveRedraw,
                  !iy && !this.chart.boosted
                ) &&
                ((e.DOMType = e.type),
                setTimeout(function () {
                  t.onMouseUp(e);
          ...
          removeBaseSeriesEvents() {
            ...
            this.navigatorEnabled &&
              ...
              e[0].xAxis &&
                iF(e[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes));
          }
          getXAxisOffsets() {
          ...
          init(e) {
            ...
            if (((e.isDirtyBox = !0), h.navigatorEnabled)) {
              ...
              (h.xAxis = new (tl())(
                ...
                c || i.series.data
                  ...
                  : 0 === e.series.length &&
                    (h.unbindRedraw = iw(e, "beforeRedraw", function () {
                      e.series.length > 0 &&
                        !h.series &&
              ...
              (h.xAxis = {
                ...
                translate: function (t, i) {
                  let s = e.xAxis[0],
                    n = s.getExtremes(),
                    r = s.len - 2 * l,
                    o = iR("min", s.options.min, n.dataMin),
                    a = iR("max", s.options.max, n.dataMax) - o;
                  return i ? (t * a) / r + o : (r * (t - o)) / a;
                },
                toPixels: function (e) {
            ...
            if (e.options.scrollbar?.enabled) {
              let t = iB(e.options.scrollbar, { vertical: e.inverted });
              iN(t.margin) || (t.margin = e.inverted ? -3 : 3),
                (e.scrollbar = h.scrollbar = new ig(e.renderer, t, e)),
                iw(h.scrollbar, "changed", function (e) {
                  let t = h.size,
                    i = t * this.to,
                    s = t * this.from;
          ...
          setOpposite() {
            let e = this.navigatorOptions,
              ...
              i = this.chart;
            this.opposite = iI(e.opposite, !!(!t && i.inverted));
          }
          getUnionExtremes(e) {
            let t,
            ...
            return (
              (e && null === i.dataMin) ||
                (t = {
                  dataMin: iI(
                    s.parse(r?.min),
                    iR("min", s.parse(o.min), i.dataMin, n.dataMin, n.min)
                  ),
                  dataMax: iI(
                    s.parse(r?.max),
                    iR("max", s.parse(o.max), i.dataMax, n.dataMax, n.max)
                  ),
                }),
              t
            );
          ...
          setBaseSeries(e, t) {
            ...
            (e =
              ...
              (i.series.length
                ? iS(i.series, (e) => !e.options.isInternal).index
                : 0)),
          ...
          updateNavigatorSeries(e, t) {
            let i = this,
              ...
              o = (i.series = (i.series || []).filter((e) => {
                ...
                return (
                  !(0 > n.indexOf(t)) ||
                  (t &&
                    (iF(t, "updatedData", i.updatedDataHandler),
            ...
            n &&
              ...
              n.forEach((e) => {
                let d = e.navigatorSeries,
                  u = ik(
                    ...
                    iD(h) ? ix.navigator.series : h
                  );
                if (d && !1 === i.navigatorOptions.adaptToUpdatedData) return;
                (r.name = "Navigator " + n.length),
                  (c = (a = e.options || {}).navigatorOptions || {}),
                  (u.dataLabels = iO(u.dataLabels)),
                  ((l = iB(a, r, u, c)).pointRange = iI(
                    u.pointRange,
                    c.pointRange,
                    ix.plotOptions[l.type || "line"].pointRange
                  ));
                let p = c.data || u.data;
              ...
              ((h.data && !(n && n.length)) || iD(h)) &&
                ((i.hasNavigatorData = !1),
                (h = iO(h)).forEach((e, t) => {
                  (r.name = "Navigator " + (o.length + 1)),
                    ((l = iB(
                      ix.navigator.series,
                      {
                        color:
          ...
          addBaseSeriesEvents() {
            ...
            t[0] &&
              ...
              t[0].eventsToUnbind.push(
                iw(t[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes)
              ),
              t.forEach((i) => {
                i.eventsToUnbind.push(
                  ...
                  !1 !== this.navigatorOptions.adaptToUpdatedData &&
                    i.xAxis &&
                    i.eventsToUnbind.push(
                      iw(i, "updatedData", this.updatedDataHandler)
                    ),
                  i.eventsToUnbind.push(
                    iw(i, "remove", function () {
                      t && iC(t, i),
                        this.navigatorSeries &&
                          e.series &&
                          (iC(e.series, this.navigatorSeries),
                          iT(this.navigatorSeries.options) &&
          ...
          shouldStickToMin(e, t) {
            let i = t.getBaseSeriesMin(e.getColumn("x")[0]),
              ...
              o = s.options.range,
              a = !0;
            return !!(iN(n) && iN(r)) && (o && n - i > 0 ? n - i < o : r <= i);
          }
          addChartEvents() {
            this.eventsToUnbind || (this.eventsToUnbind = []),
              this.eventsToUnbind.push(
                iw(this.chart, "redraw", function () {
                    ...
                    (this[t] =
                      ...
                      (e.navigatorEnabled || !this.inverted
                        ? e.height +
                          ...
                          e.scrollbarHeight
                        : 0) +
                      (e.navigatorOptions.margin || 0));
                }),
                iw(iL, "setRange", function (e) {
          ...
          destroy() {
            this.removeEvents(),
              this.xAxis &&
                (iC(this.chart.xAxis, this.xAxis),
                iC(this.chart.axes, this.xAxis)),
              this.yAxis &&
                (iC(this.chart.yAxis, this.yAxis),
                iC(this.chart.axes, this.yAxis)),
        ...
        let { animObject: iH } = w(),
          { format: iz } = D(),
          { clamp: iq, pick: iU, syncTimeout: iG } = w(),
          { getFakeMouseEvent: iK } = S,
          {
            getAxisRangeDescription: iV,
            fireEventOnWrappedOrUnwrappedElement: iW,
          } = G,
          iX = class extends Z {
            init() {
              let e = this.chart,
              ...
              (this.announcer = new ep(e, "polite")),
                this.addEvent(iL, "afterRender", function () {
                  this.chart === t.chart &&
                    this.chart.renderer &&
                    iG(() => {
                    ...
                    }, iH(iU(this.chart.renderer.globalAnimation, !0)).duration);
                });
            }
            onChartUpdate() {
              let e = this.chart,
                ...
                [0, 1].forEach((t) => {
                  ...
                  if (i) {
                    let s = this.proxyProvider.addProxyElement(
                      ...
                      {
                        type: "range",
                        "aria-label": iz(n, { handleIx: t, chart: e }, e),
                      }
                    );
              ...
              return new Q(i, {
                keyCodeMap: [
                  [
                    ...
                    function (r) {
                      if (s) {
                        let o = r === n.left || r === n.up ? -1 : 1;
                        (s.value = "" + iq(parseFloat(s.value) + o, 0, 100)),
                          t.updateNavigator(() => {
                            let n = t.getHandleByIx(e);
                            n && i.setFocusToElement(n, s);
                          });
                      }
                ...
                (this.updateNavigatorThrottleTimer = setTimeout(
                  ((e) => {
                    let t = this.chart,
                      ...
                      n = this.chart.accessibility?.keyboardNavigation;
                    if (i && s && this.minHandleProxy && this.maxHandleProxy) {
                      ...
                      [
                        ...
                        n &&
                          iW(
                            ...
                            iK(
                              t,
                              { x: r.left + i.left + s, y: r.top + i.top },
                              n
                            )
                          );
                      }),
                      ...
                      this.announcer.announce(
                        iz(l, { axisRangeDescription: h, chart: t }, t)
                      );
                    }
                  }).bind(this, e),
                  20
          ...
          { getPointAnnotationTexts: iY } = ev,
          {
            getAxisDescription: ij,
            getSeriesFirstPointElement: i_,
            getSeriesA11yElement: iZ,
            unhideChartElementFromAT: i$,
          } = G,
          { format: iQ, numberFormat: iJ } = D(),
          { reverseChildNodes: i0, stripHTMLTagsFromString: i1 } = S,
          { find: i2, isNumber: i3, isString: i5, pick: i4, defined: i6 } = w();
        function i9(e) {
          let t =
        ...
        function i8(e, t) {
          ...
          return i3(t)
            ? iJ(
                t,
                r.valueDecimals || n.valueDecimals || o.valueDecimals || -1,
                a.decimalPoint,
                  ...
                  ? (function (e) {
                      let t = (function (e) {
                          let t = e.series,
                            ...
                            r = t.xAxis && t.xAxis.dateTime;
                          if (r) {
                            let t = r.getXDateFormat(
                                e.x || 0,
                        ...
                        s = i6(e.id) && 0 > ("" + e.id).indexOf("highcharts-"),
                        n = "x, " + e.x;
                  ...
                  value: (function (e) {
                    let t = e.series,
                      ...
                      s =
                        ...
                        {},
                      n = t.tooltipOptions || {},
                      r = s.valuePrefix || i.valuePrefix || n.valuePrefix || "",
                      o = s.valueSuffix || i.valueSuffix || n.valueSuffix || "",
                    ...
                    if (t.pointArrayMap) {
                      let t = r || "",
                        i = o || "",
                        s = function (s) {
                          let n = i8(e, i4(e[s], e.options[s]));
                          return void 0 !== n ? s + ": " + t + n + i : n;
                        };
        ...
        function st(e) {
          let t = e.chart,
            ...
            o = i7(e, "xAxis"),
            a = i7(e, "yAxis"),
            l = { seriesNumber: r, series: e, chart: t },
        ...
        let si = {
            defaultPointDescriptionFormatter: se,
            defaultSeriesDescriptionFormatter: st,
            describeSeries: function (e) {
              let t = e.chart,
                ...
                n = t.is3d && t.is3d();
              if (s) {
                s.lastChild !== i || n || i0(s);
                let r = (function (e) {
                    let t = e.options.accessibility || {};
                    return !i9(e) && !t.exposeAsGroupOnly;
                  })(e),
                  o = (function (e) {
                    let t =
                  ...
                  a = e.chart.options.accessibility.point.describeNull;
                if (
                  ((r || o) &&
                    e.points.forEach((t) => {
                      let i =
                          (t.graphic && t.graphic.element) ||
                          ((function (e) {
                            let t = e.series,
                              i = t && t.chart,
                              s = t && t.is("sunburst"),
                            ...
                            (function (e) {
                              let t = e.series,
                                i = (function (e) {
                                  let t = e.index;
                                  if (!e.series || !e.series.data || !i6(t))
                                    return null;
                                  let i = e.series.options?.nullInteraction;
                                  return (
                                    i2(e.series.data, function (e) {
                                      return !!(
                                        e &&
                                        void 0 !== e.index &&
                                        (i || e.index > t) &&
                                ...
                                r = i
                                  ? {
                                      x: i4(e.plotX, i.plotX, 0),
                                      y: i4(e.plotY, i.plotY, 0),
                                    }
                                  : { x: i4(e.plotX, 0), y: i4(e.plotY, 0) },
                                o = (function (e, t) {
                      ...
                      if (i) {
                        if (t.isNull && !a)
                          return void i.setAttribute("aria-hidden", !0);
                        if (
                          (i.setAttribute("tabindex", "-1"),
                          e.chart.styledMode || (i.style.outline = "none"),
                          r && !s)
                        ) {
                          let e = t.series,
                            s = e.options.accessibility?.point || {},
                            n = e.chart.options.accessibility.point || {},
                            r = i1(
                              (i5(s.descriptionFormat) &&
                                iQ(s.descriptionFormat, t, e.chart)) ||
                                s.descriptionFormatter?.(t) ||
                                (i5(n.descriptionFormat) &&
                                  iQ(n.descriptionFormat, t, e.chart)) ||
                        ...
                        } else i.setAttribute("aria-hidden", !0);
                      }
                    }),
                  i$(t, s),
                  (function (e) {
                    let t = e.chart,
                      ...
                      n = t.series.length > 1,
                      r = t.options.accessibility.series.describeSingleSeries,
                      o = (e.options.accessibility || {}).exposeAsGroupOnly;
                    return !(s && n) && (n || r || o || i9(e));
                  })(e))
                ) {
                  let t = e.options.accessibility || {},
                    i = e.chart.options.accessibility,
                    n = i.landmarkVerbosity;
                  t.exposeAsGroupOnly
                    ...
                    e.chart.styledMode || (s.style.outline = "none"),
                    s.setAttribute(
                      "aria-label",
                      i1(
                        (i.series.descriptionFormatter &&
                          i.series.descriptionFormatter(e)) ||
                          st(e),
                        e.chart.renderer.forExport
                      )
                    );
          ...
          { composed: ss } = w(),
          { addEvent: sn, defined: sr, pushUnique: so } = w(),
          { getChartTitle: sa } = G,
          {
            defaultPointDescriptionFormatter: sl,
            defaultSeriesDescriptionFormatter: sh,
          } = si;
        function sc(e) {
        ...
        class sd {
          ...
          onSeriesAdded(e) {
            sc(this.chart) &&
              ...
              (this.dirty.newSeries = sr(this.dirty.newSeries) ? void 0 : e));
          }
          announceDirtyData() {
            let e = this.chart,
              t = this;
          ...
          queueAnnouncement(e, t, i) {
            ...
            if (s.enabled) {
              let n = +new Date(),
                r = n - this.lastAnnouncementTime,
                o = Math.max(0, s.minAnnounceInterval - r),
                a = (function (e, t) {
                  let i = (e || [])
                    .concat(t || [])
              ...
              l &&
                ...
                (this.queuedAnnouncement = { time: n, message: l, series: a }),
          ...
          buildAnnouncementMessage(e, t, i) {
            ...
            if (n.announcementFormatter) {
              let s = n.announcementFormatter(e, t, i);
              if (!1 !== s) return s.length ? s : null;
            }
            let r = w().charts && w().charts.length > 1 ? "Multiple" : "Single",
              o = t
                ? "newSeriesAnnounce" + r
                : i
                ? "newPointAnnounce" + r
            ...
            return s.langFormat("accessibility.announceNewData." + o, {
              chartTitle: a,
              seriesDesc: t ? sh(t) : null,
              pointDesc: i ? sl(i) : null,
              point: i,
              series: t,
            });
          }
        ...
        !(function (e) {
          function t(e) {
            ...
            i &&
              i.chart === t &&
              sc(t) &&
              (i.dirty.newPoint = sr(i.dirty.newPoint) ? void 0 : e.point);
          }
          function i() {
            let e = this.chart,
          ...
          e.compose = function (e) {
            so(ss, "A11y.NDA") &&
              (sn(e, "addPoint", t), sn(e, "updatedData", i));
          };
        })(sd || (sd = {}));
        let su = sd,
          { doc: sp, win: sg } = w(),
          { attr: sm, css: sb, merge: sf } = w(),
          { fireEventOnWrappedOrUnwrappedElement: sx } = G,
          {
            cloneMouseEvent: sy,
            cloneTouchEvent: sv,
            getFakeMouseEvent: sw,
            removeElement: sE,
          } = S,
          sA = class {
            constructor(e, t, i = "button", s, n) {
              (this.chart = e),
                (this.target = t),
                (this.eventProvider = new Y());
              let r = (this.innerElement = sp.createElement(i)),
                o = (this.element = s ? sp.createElement(s) : r);
              e.styledMode || this.hideElementVisually(r),
                s &&
                  ("li" !== s || e.styledMode || (o.style.listStyle = "none"),
                  o.appendChild(r),
                  (this.element = o)),
                this.updateTarget(t, n);
            }
            click() {
              let e = this.getTargetPosition();
              (e.x += e.width / 2), (e.y += e.height / 2);
              let t = sw("click", e);
              sx(this.target.click, t);
            }
            updateTarget(e, t) {
              ...
              sm(this.innerElement, sf(s ? { "aria-label": s } : {}, i)),
                this.eventProvider.removeAddedEvents(),
            ...
            addProxyEventsToElement(e, t) {
              [
                ...
                this.eventProvider.addEvent(
                  ...
                  (e) => {
                    let i = s ? sv(e) : sy(e);
                    t && sx(t, i), e.stopPropagation(), s || e.preventDefault();
                  },
                  { passive: !1 }
                );
              });
            ...
            getTargetPosition() {
              ...
              if (s && i?.getBoundingClientRect && n) {
                let e = sg.scrollY || sp.documentElement.scrollTop,
                  t = i.getBoundingClientRect(),
                  s = n.getChartPosition();
                return {
                  x: (t.left - s.left) / s.scaleX,
                  y: (t.top + e - s.top) / s.scaleY,
                  width: t.right / s.scaleX - t.left / s.scaleX,
                  height: t.bottom / s.scaleY - t.top / s.scaleY,
                };
              }
          ...
          { doc: sT } = w(),
          { attr: sM, css: sC } = w(),
          { unhideChartElementFromAT: sk } = G,
          { removeChildNodes: sS } = S,
          sP = class {
            constructor(e) {
              (this.chart = e),
                (this.domElementProvider = new W()),
            ...
            addProxyElement(e, t, i = "button", s) {
              ...
              let r = "ul" === n.type || "ol" === n.type ? "li" : void 0,
                o = new sA(this.chart, t, i, r, s);
              return (
                n.proxyContainerElement.appendChild(o.element),
                n.proxyElements.push(o),
                o
              );
            }
            addGroup(e, t = "div", i) {
              ...
              let r = this.domElementProvider.createElement(t);
              return (
                i && i.role && "div" !== t
                  ? (s =
                ...
                (s.className =
                  ...
                  e.replace(/\W/g, "-")),
                (this.groups[e] = {
                  proxyContainerElement: r,
                  groupElement: s,
                  type: t,
                  proxyElements: [],
                }),
                sM(s, i || {}),
                "ul" === t && r.setAttribute("role", "list"),
            ...
            updatePosContainerPositions() {
              ...
              e.container.insertBefore(
                ...
                sk(this.chart, this.afterChartProxyPosContainer),
                sk(this.chart, this.beforeChartProxyPosContainer);
            }
          },
          { unhideChartElementFromAT: sD, getAxisRangeDescription: sN } = G,
          { addEvent: sB, attr: sI } = w();
        class sF extends Z {
          init() {
            let e = this.chart;
            this.announcer = new ep(e, "polite");
          ...
          updateSelectorVisibility() {
            ...
            t && t.hasVisibleDropdown && i
              ? (sD(e, i), s.forEach((e) => n(e.element)))
              : (i && n(i), s.forEach((t) => sD(e, t.element)));
          }
          setDropdownAttrs() {
            let e = this.chart,
          ...
          setRangeButtonAttrs(e) {
            sI(e.element, { tabindex: -1, role: "button" });
          }
          ...
          onButtonNavKbdArrowKey(e, t) {
            let i = e.response,
              s = this.keyCodes,
              n = this.chart,
              r = n.options.accessibility.keyboardNavigation.wrapAround,
              o = t === s.left || t === s.up ? -1 : 1;
            return n.highlightRangeSelectorButton(
              n.highlightedRangeSelectorItemIx + o
            )
              ? i.success
              : r
              ? (e.init(o), i.success)
          ...
          onInputNavInit(e) {
            let t = this,
              ...
              s = e > 0 ? 0 : 1,
              n = i.rangeSelector,
              r = n && n[s ? "maxDateBox" : "minDateBox"],
              o = n && n.minInput,
              a = n && n.maxInput;
            if (((i.highlightedInputRangeIx = s), r && o && a)) {
              i.setFocusToElement(r, s ? a : o),
          ...
          initDropdownNav() {
            ...
            t &&
              ...
              this.removeDropdownKeydownHandler &&
                this.removeDropdownKeydownHandler(),
              (this.removeDropdownKeydownHandler = sB(i, "keydown", (t) => {
        ...
        !(function (e) {
          ...
          e.compose = function (e, s) {
            ...
            n.highlightRangeSelectorButton ||
              ((n.highlightRangeSelectorButton = t), sB(s, "afterBtnClick", i));
          };
        })(sF || (sF = {}));
        let sO = sF,
          { composed: sR } = w(),
          { addEvent: sL, merge: sH, pushUnique: sz } = w();
        !(function (e) {
          function t(e) {
            sH(!0, e, {
          ...
          function r(e) {
            this.resetA11yMarkerOptions = sH(
              e.options.marker || {},
                ...
                s(this) &&
                  (function (e) {
                    ...
                    for (; s--; ) {
                      let r = e.points[s],
                        o = r.options,
                        a = r.hasForcedA11yMarker;
                      if ((delete r.hasForcedA11yMarker, o.marker)) {
                        var n;
                        let e = a && 0 === i(o);
                        o.marker.enabled && !e
                          ? (sH(!0, (n = o).marker, {
          ...
          function a() {
            this.boosted &&
              this.a11yMarkersForced &&
              (sH(!0, this.options, { marker: { enabled: !1 } }),
              delete this.a11yMarkersForced);
          }
          e.compose = function (e) {
            sz(sR, "A11y.FM") &&
              (sL(e, "afterSetOptions", r),
              sL(e, "render", o),
              sL(e, "afterRender", n),
              sL(e, "renderCanvas", a));
          };
        ...
        var sU = x(260),
          ...
          sK = x(820),
          sV = x.n(sK);
        let { seriesTypes: sW } = tF(),
          { doc: sX } = w(),
          { defined: sY, fireEvent: sj } = w(),
          {
            getPointFromXY: s_,
            getSeriesFromName: sZ,
            scrollAxisToPoint: s$,
          } = G;
        function sQ(e) {
          let t = e.index,
        ...
        function s0(e) {
          let t = e.series,
            i = t.options.nullInteraction,
            s = e.options.accessibility,
            n = t.chart.options.accessibility,
            r = s?.enabled === !1;
          return (
            n.keyboardNavigation.seriesNavigation.skipNullPoints ??
            ((!(!e.isNull || i) && !1 === e.visible) ||
              !1 === e.isInside ||
              r ||
              sJ(t))
          );
          ...
          for (let e = 0; e < i; ++e)
            if (!sJ(t[e])) {
              let i = (function (e) {
                let t = e.points || [],
                  i = t.length;
                for (let e = 0; e < i; ++e) if (!s0(t[e])) return t[e];
                return null;
              })(t[e]);
              if (i) return i;
            }
        ...
        class s5 {
          ...
          init() {
            ...
            i.addEvent(sV(), "destroy", function () {
              ...
              i.addEvent(sG(), "afterSetState", function () {
                let e = this.graphic && this.graphic.element,
                  i = sX.activeElement,
                  s = i && i.getAttribute("class"),
                  n = s && s.indexOf("highcharts-a11y-proxy-element") > -1;
          ...
          onDrillupAll() {
            let e,
              t = this.lastDrilledDownPoint,
              i = this.chart,
              s = t && sZ(i, t.seriesName);
            t && s && sY(t.x) && sY(t.y) && (e = s_(s, t.x, t.y)),
              (e = e || s1(i)),
            ...
            return new Q(i, {
              keyCodeMap: [
                ...
                [
                  [t.home],
                  function () {
                    return s3(i), this.response.success;
                  },
                ],
                [
                  [t.end],
                  function () {
                    return s2(i), this.response.success;
                  },
                ],
                [
                  [t.pageDown, t.pageUp],
          ...
          onKbdVertical(e, t) {
            let i = this.chart,
              ...
              r = i.options.accessibility.keyboardNavigation.seriesNavigation;
            if (r.mode && "serialize" === r.mode)
            ...
            return i[o](n), e.response.success;
          }
          onHandlerTerminate() {
            let e = this.chart,
        ...
        !(function (e) {
          ...
          function i(e) {
            ...
            return (
              ...
              (this.series.forEach((n) => {
                sJ(n) ||
                  n.points.forEach((r) => {
                    if (!sY(r.plotY) || !sY(r.plotX) || r === t) return;
                    let o = r.plotY - t.plotY,
                      a = Math.abs(r.plotX - t.plotX),
                      l = Math.abs(o) * Math.abs(o) + a * a * 4;
                    n.yAxis && n.yAxis.reversed && (o *= -1),
                      !((o <= 0 && e) || (o >= 0 && !e) || l < 5 || s0(r)) &&
                        l < i &&
                        ((i = l), (s = r));
                  });
              }),
          ...
          function s(e) {
            let t,
              ...
              o = r && r.points && r.points[r.points.length - 1];
              ...
              ? !!(t = this.series[n.series.index + (e ? -1 : 1)]) &&
                  !!(i = (function (e, t, i, s) {
                    let n = 1 / 0,
                      ...
                      a,
                      l = t.points.length,
                      h = (e) => !(sY(e.plotX) && sY(e.plotY));
                    if (!h(e)) {
                      for (; l--; )
                        !h((r = t.points[l])) &&
                          (a =
                            (e.plotX - r.plotX) * (e.plotX - r.plotX) * 4 +
                            (e.plotY - r.plotY) * (e.plotY - r.plotY) * 1) <
                            n &&
                          ((n = a), (o = l));
                      return sY(o) ? t.points[o] : void 0;
                    }
                  })(n, t, 4)) &&
                  (sJ(t)
          ...
          function r() {
            let e = this.chart.highlightedPoint,
              t = (e && e.series) === this ? sQ(e) : 0,
              i = this.points,
              s = i.length;
            if (i && s) {
              for (let e = t; e < s; ++e)
                if (!s0(i[e])) return i[e].highlight();
              for (let e = t; e >= 0; --e)
                if (!s0(i[e])) return i[e].highlight();
            }
            return !1;
          ...
          e.compose = function (e, o, a) {
            ...
            l.highlightAdjacentPoint ||
              ...
              ["column", "gantt", "pie"].forEach((e) => {
                sW[e] && (sW[e].prototype.keyboardMoveVertical = !1);
              }),
              (c.highlightNextValidPoint = r));
          };
        })(s5 || (s5 = {}));
        let s4 = s5,
          { hideSeriesFromAT: s6 } = G,
          { describeSeries: s9 } = si,
          s8 = class extends Z {
            static compose(e, t, i) {
              su.compose(i), sq.compose(i), s4.compose(e, t, i);
            }
            init() {
              (this.newDataAnnouncer = new su(this.chart)),
                this.newDataAnnouncer.init(),
                (this.keyboardNavigation = new s4(this.chart, this.keyCodes)),
          ...
          { unhideChartElementFromAT: s7 } = G,
          { getFakeMouseEvent: ne } = S,
          { attr: nt, pick: ni } = w(),
          ns = class extends Z {
            constructor() {
            ...
            onMapKbdArrow(e, t) {
              let i = this.chart,
                ...
                r = t === s.up || t === s.down,
                o = t === s.left || t === s.up ? 1 : -1,
                a = ((r ? i.plotHeight : i.plotWidth) / 10) * o,
                l = 10 * Math.random(),
                h = {
                  x: n.offsetLeft + i.plotLeft + i.plotWidth / 2 + l,
                  y: n.offsetTop + i.plotTop + i.plotHeight / 2 + l,
                },
                c = r ? { x: h.x, y: h.y + a } : { x: h.x + a, y: h.y };
              return (
                [
                  ne("mousedown", h),
                  ne("mousemove", c),
                  ne("mouseup", c),
                ].forEach((e) => n.dispatchEvent(e)),
                e.response.success
              );
            }
            onMapKbdTab(e, t) {
              ...
              return new Q(r, {
                keyCodeMap: [
                  ...
                  [
                    [s.space, s.enter],
                    function () {
                      return ni(i(this, r), this.response.success);
                    },
                  ],
                ],
                validate: function () {
                  return r[e] && r[e].box && n[t].innerElement;
                },
                init: function () {
                  r.setFocusToElement(r[e].box, n[t].innerElement);
                },
              });
            }
            getKeyboardNavigation() {
          ...
          { doc: nn, isMS: nr, win: no } = w(),
          na = {
            isHighContrastModeActive: function () {
              if (nr && no.getComputedStyle) {
                let e = nn.createElement("div");
                (e.style.backgroundImage =
                  "url(data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==)"),
                  nn.body.appendChild(e);
                let t = (e.currentStyle || no.getComputedStyle(e))
                  .backgroundImage;
                return nn.body.removeChild(e), "none" === t;
              }
              return (
                no.matchMedia &&
                no.matchMedia("(forced-colors: active)").matches
              );
            },
        ...
        function nd(e, t, i) {
          let s = e,
            n,
            r = 0;
          for (; r < t.length - 1; ++r) s = s[(n = t[r])] = nc(s[n], {});
          s[t[t.length - 1]] = i;
        }
        function nu(e, t, i, s) {
          function n(e, t) {
        ...
        let np = function (e) {
            ...
            ["description", "typeDescription"].forEach(function (s) {
              t[s] &&
                ((i[s] = t[s]),
                nh(32, !1, e, { [`chart.${s}`]: `use accessibility.${s}` }));
            }),
              ...
              nu(e, ["accessibility"], ["accessibility"], {
              ...
              nu(e, ["lang", "accessibility"], ["lang", "accessibility"], {
          ...
          { defaultOptions: ng } = w(),
          { doc: nm } = w(),
          { addEvent: nb, extend: nf, fireEvent: nx, merge: ny } = w(),
          { removeElement: nv } = S;
        class nw {
          constructor(e) {
            this.init(e);
          ...
          init(e) {
            if (((this.chart = e), !nm?.addEventListener)) {
              (this.zombie = !0),
                (this.components = {}),
            ...
            np(e),
              (this.proxyProvider = new sP(this.chart)),
              this.initComponents(),
          ...
          initComponents() {
            ...
            (this.components = {
              ...
              legend: new to(),
              chartMenu: new eV(),
              rangeSelector: new sO(),
              series: new s8(),
              zoom: new ns(),
              navigator: new iX(),
            }),
              i.customComponents && nf(this.components, i.customComponents);
          ...
          update() {
            let e = this.components,
              t = this.chart,
              i = t.options.accessibility;
            nx(t, "beforeA11yUpdate"), (t.types = this.getChartTypes());
            let s = i.keyboardNavigation.order;
            this.proxyProvider.updateGroupOrder(s),
              this.getComponentOrder().forEach(function (i) {
                e[i].onChartUpdate(),
                  nx(t, "afterA11yComponentUpdate", {
                    name: i,
                    component: e[i],
                  });
              }),
              ...
              !t.highContrastModeActive &&
                ...
                (na.isHighContrastModeActive() || !0 === i.highContrastMode) &&
                na.setHighContrastTheme(t),
              nx(t, "afterA11yUpdate", { accessibility: this });
          }
          destroy() {
            let e = this.chart || {},
              t = this.components;
            Object.keys(t).forEach(function (e) {
              ...
              e.announcerContainer && nv(e.announcerContainer),
        ...
        !(function (e) {
          ...
          function s(e) {
            ...
            t &&
              ...
              ny(!0, this.options.accessibility, t),
              this.accessibility &&
            ...
            if (i && i.enabled)
              ...
              this.renderTo.setAttribute("role", "img"),
                ...
                this.renderTo.setAttribute(
                  "aria-label",
                  ((n && n.element.textContent) || "").replace(/</g, "&lt;")
                ),
          ...
          ny(
            ...
            {
              accessibility: { highContrastTheme: nl },
              lang: {
                accessibility: {
        ...
        let nE = nw,
          nA = w();
        (nA.i18nFormat = nE.i18nFormat),
          (nA.A11yChartUtilities = G),
          (nA.A11yHTMLUtilities = S),
          (nA.AccessibilityComponent = Z),
          (nA.KeyboardNavigationHandler = Q),
          (nA.SeriesAccessibilityDescriber = si),
          nE.compose(
            nA.Chart,
            nA.Legend,
            nA.Point,
