...
!(function (n) {
        ...
        : ((k = void 0 === (P = e)),
          ...
          this.each(function () {
            ...
            if ("table" != this.nodeName.toLowerCase())
              ...
              t.on && t.on.options && lt(a, "options", t.on.options),
                ...
                for (g = w.length - 1; 0 <= g; g--) {
                  var L =
                    void 0 !== (x = w[g]).target
                      ...
                      : x.aTargets;
                  for (
                    Array.isArray(L) || (L = [L]), v = 0, b = L.length;
                    v < b;
                    v++
                  ) {
                    var A = L[v];
                    if ("number" == typeof A && 0 <= A) {
                      ...
                      for (y = 0, D = I.length; y < D; y++)
                        "_all" === A
                          ? C(y, x)
                          : -1 !== A.indexOf(":name")
                          ? I[y].sName === A.replace(":name", "") && C(y, x)
              ...
              var N,
                ...
                F =
                  ...
                  c.oFeatures);
              if ((t.bStateSave && (F.bStateSave = !0), void 0 === t.aaSorting))
              ...
              var n = a.children("caption"),
                n =
                  (c.caption &&
                    (n = 0 === n.length ? H("<caption/>").appendTo(a) : n).html(
                      c.caption
                    ),
                  n.length &&
              ...
              H.extend(!0, R, t.oLanguage),
                R.sUrl
                  ? H.ajax({
                      ...
                      error: function () {
                        z(c, 0, "i18n file loading error", 21), He(c);
                      },
                    })
  ...
  function ne(e) {
    ...
    var o = e.oScroll;
    ("" === o.sY && "" === o.sX) || Ue(e), G(e, null, "column-sizing", [e]);
  }
  function re(e, t) {
    e = ie(e, "bVisible");
  ...
  function ye(e, t, n, r) {
    ...
    return (
      t && (t = t.getAttribute("id")) && m(e.rowId)(r, t), { data: r, cells: u }
    );
  }
  function De(e, t) {
    var n = e.aoData[t],
      ...
      if (0 !== o.length)
        for (var d = a ? e.aoData.length : s, f = a ? 0 : i; f < d; f++) {
          for (
            ...
            var v = u[m],
              b = p.anCells[m];
            y(b, T.type.className[v.sType]), y(b, e.oClasses.tbody.cell);
          }
  ...
  function Ce(e, t, n) {
    ...
    (void 0 !== n && !0 !== n) ||
      (se(e),
      a && Ze(e),
      r ? Re(e, e.oPreviousSearch) : (e.aiDisplay = e.aiDisplayMaster.slice())),
  ...
  function Ae(t) {
    ...
    n.oFeatures.bProcessing &&
      ...
      m ? r.prependTo(H("div.dt-scroll", n.nTableWrapper)) : r.insertBefore(e),
          ...
          for (
            y = (y = +a.getAttribute("colspan")) && 0 != y && 1 != y ? y : 1,
              ...
              n &&
                (s &&
                  ...
                  f
                    ? (null === m.sTitle ||
                      ...
                      !m.sTitle &&
                        s &&
                        ((m.sTitle = w(a.innerHTML)), (m.autoTitle = !0)))
                ...
                0 ===
                  H("span.dt-column-" + (b = f ? "header" : "footer"), a)
                    .length) &&
                H("<div>")
        ...
        if (c[d] && !(l = c[d])._aFilterData) {
          for (o = [], r = 0, a = u.length; r < a; r++)
            u[r].bSearchable
              ...
              i.indexOf &&
                -1 !== i.indexOf("&") &&
                ((ke.innerHTML = i), (i = Me ? ke.textContent : ke.innerText)),
            ...
            ("ssp" == c && !u) ||
              ("ajax" == c
                ? Fe(i, {}, function (e) {
                    ...
                    (i.iInitDisplayStart = n), Ce(i), I(i, !1), We(i);
                  })
                : (We(i), I(i, !1)));
        }),
  ...
  function Ue(t) {
    ...
    if (t.scrollBarVis !== h && void 0 !== t.scrollBarVis)
      ...
      if (
        ...
        for (
          var p = null, g = "ssp" !== J(t) ? t._iDisplayStart : 0, m = g;
  ...
  function Ze(e, t, n) {
    ...
    for (
      ...
      (i = c[r]), (S = x = D = g = p = h = y = b = v = m = void 0);
      var h,
        p,
        g,
        m = e,
      ...
      y && (h = y.call(m.oInstance, m, v, ae(m, v)));
      for (
          ...
          if (c.length === o.length) {
            for (n = 0, a = c.length; n < a; n++) {
              ...
              void 0 !== f.visible &&
                ...
                void 0 !== f.search && H.extend(r.aoPreSearchCols[n], f.search);
            }
            l && l.columns.adjust();
          }
        }
    ...
    (X.register = r =
      function (e, t) {
        if (Array.isArray(e))
          ...
          for (var a = e.split("."), o = ut, i = 0, l = a.length; i < l; i++) {
            var s,
              u,
              c = (function (e, t) {
    ...
    e &&
      ...
      "ssp" == J(a)
        ...
        : (I(a, !0),
          ...
          Fe(a, {}, function (e) {
            ve(a);
            for (var t = Oe(a, e), n = 0, r = t.length; n < r; n++) D(a, t[n]);
            Ce(a, o), We(a), I(a, !1);
          }));
  }
  ...
  r("tables()", function (e) {
    ...
    r("draw()", function (t) {
      return this.iterator("table", function (e) {
        "page" === t
          ? x(e)
          : Ce(e, !1 === (t = "string" == typeof t ? "full-hold" !== t : t));
      });
    }),
    r("page()", function (t) {
      return void 0 === t
            ...
            return (
              (t = ft(
                ...
                function (n) {
                  ...
                  if (((i = i || xt(a, o)), null !== e && -1 !== i.indexOf(e)))
                    return [e];
      ...
      (r(Ct, function (e, t) {
        ...
        return void 0 === e
          ...
          : (!0 === e
              ...
              : !1 === e
              ? Tt(this)
              : n.length && this.length && gt(n[0], n[0].aoData[this[0]], e, t),
            this);
      }),
            ...
            function (n) {
              ...
              if ("function" == typeof n)
                return (
                  (r = xt(i, l)),
                  c.map(function (e, t) {
                    return n(t, vt(i, t, 0, 0, r), bt(i, t)) ? t : null;
                  })
                );
              var t,
                a,
          ...
          this.iterator("table", function (e) {
            _e(e, e.aoHeader),
              ...
              t.iterator("column", function (e, t) {
                a.includes(t) && G(e, null, "column-visibility", [e, t, n, r]);
              }),
  ...
  r("cells()", function (g, e, m) {
    ...
    r("state()", function (e, t) {
      ...
      return e
        ? ((n = H.extend(!0, {}, e)),
          this.iterator("table", function (e) {
            !1 !== t && (n.time = +new Date() + 100), et(e, n, function () {});
          }))
        : this.context.length
    ...
    (V.use = function (e, t) {
      ...
      "lib" === t || "jq" === t || (n && n.fn && n.fn.jquery)
        ...
        ? (i = n)
        : "bootstrap" === t || (n && n.Modal && "modal" === n.Modal.NAME)
        ? (yt = n)
        ...
        function (e, t) {
          ...
          return (
            ...
            "type" === t
              ...
              : ((e =
                  null === a
                    ? Nt(n, "toDate", "toJSDate", "")[s]()
                    : Nt(n, "format", "toFormat", "toISOString", a)),
                "display" === t ? u(e) : e)
          );
        }
      );
  ...
  H.extend(!0, V.ext.renderer, {
    ...
    header: {
      _: function (g, m, v) {
        m.addClass(v.thead.cell), g.oFeatures.bSort || m.addClass(v.order.none);
        var e = g.titleRow,
    ...
    (V.feature.register = function (e, t, n) {
      (V.ext.features[e] = t), n && T.feature.push({ cFeature: n, fnInit: t });
    }),
  ...
  function qt(e, t, n, r) {
    ...
    return (
      t <= n
        ...
        : t - 1 - o <= e
        ? ((a = h(t - (n - i), t)).unshift("ellipsis"), r && a.unshift(0))
  ...
  V.feature.register(
            ...
            (a.return && "Enter" !== e.key) ||
              (t != a.search &&
                Be(n, r.processing, function () {
                  (a.search = t), Re(n, a), (n._iDisplayStart = 0), x(n);
                }));
          }),
    ...
    V.feature.register(
      ...
      function (e, t) {
            ...
            for (var p = 0; p < f.length; p++) {
              ...
              H(v.clicker).attr({
                ...
                nt(v.clicker, { action: g }, function (e) {
                  e.preventDefault(), Ve(t, e.data.action, !0);
                }),
                h.push(v.display);
            }
        ...
        return (
          e.aoDrawCallback.push(n), H(e.nTable).on("column-sizing.dt.DT", n), r
        );
      },
      "p"
    );
