    ...
    (() => {
      ...
      function v(e) {
        ...
        if (
          ...
          let e = y.atob(t[3]),
            n = new y.ArrayBuffer(e.length),
            i = new y.Uint8Array(n);
          for (let t = 0; t < i.length; ++t) i[t] = e.charCodeAt(t);
          return b.createObjectURL(new y.Blob([i], { type: t[1] }));
        }
      }
      let { isTouchDevice: S } = h(),
        C = {
          exporting: {
            allowTableSorting: !0,
      ...
      let E = o,
        { composed: O } = h(),
        { addEvent: T, fireEvent: k, pushUnique: F } = h();
      function R() {
      ...
      let { win: P } = h(),
        { discardElement: H, objectEach: L } = h(),
        M = {
          ajax: function (e) {
            let t = {
          ...
          post: async function (e, t, n) {
            ...
            L(t, function (e, t) {
              ...
              i.append("b64", "true");
            let o = await P.fetch(e, { method: "POST", body: i, ...n });
            if (o.ok) {
              let e = await o.text(),
        ...
        { defaultOptions: A, setOptions: D } = h(),
        { downloadURL: U, getScript: I } = {
          dataURLtoBlob: v,
          ...
          getScript: function (e) {
            return new Promise((t, n) => {
              let i = x.getElementsByTagName("head")[0],
      ...
      class eh {
        ...
        static async fetchStyleSheets() {
          let e = [];
          for (let t of Array.from(B.styleSheets))
            await eh.handleStyleSheet(t, e);
          return e;
        }
        static async inlineFonts(e) {
          let t = await eh.fetchStyleSheets(),
            n = /url\(([^)]+)\)/g,
            i = [],
            o = t.join("\n"),
            r;
        ...
        static svgToDataURL(e) {
          let t = q.navigator.userAgent,
            n = t.indexOf("WebKit") > -1 && 0 > t.indexOf("Chrome");
          try {
            if (!n && -1 === e.indexOf("<foreignObject"))
              return ec.createObjectURL(
                new q.Blob([e], { type: "image/svg+xml;charset-utf-16" })
              );
          } catch {}
        ...
        addButton(e) {
          let t,
            ...
            i = n.chart,
            o = i.renderer,
            r = en(i.options.navigation?.buttonOptions, e),
            a = r.onclick,
            s = r.menuItems,
            l = r.symbolSize || 12;
          ...
          a
            ...
            r.text && r.symbol
              ? (c.paddingLeft = eo(c.paddingLeft, 30))
              : r.text ||
                Z(c, { width: r.width, height: r.height, padding: 0 });
          let p = o
            .button(
              r.text || "",
              0,
            ...
            .attr({ title: eo(i.options.lang[r._titleKey || r.titleKey], "") });
          (p.menuClassName =
            e.menuClassName || "highcharts-menu-" + n.btnCount++),
            r.symbol &&
              ((t = o
                .symbol(
                  r.symbol,
            ...
            p
              .add(n.group)
              .align(
                Z(r, { width: p.width, x: eo(r.x, n.buttonOffset) }),
                !0,
                "spacingBox"
              ),
            (n.buttonOffset +=
        ...
        beforePrint() {
          ...
          (this.isPrinting = !0),
            ...
            [].forEach.call(i.childNodes, function (e, t) {
              1 === e.nodeType &&
                ((i.origDisplay[t] = e.style.display),
          ...
          m ||
            ...
            (m.hideMenu = function () {
              _(m, { display: "none" }),
                ...
                _(l.renderTo, { overflow: "hidden" }),
                _(l.container, { overflow: "hidden" }),
                K(m.hideTimer),
                ee(l, "exportMenuHidden");
            }),
            s.events?.push(
              z(m, "mouseleave", function () {
            ...
            t.forEach(function (e) {
              if (
                ("string" == typeof e &&
                  s.options.menuItemDefinitions?.[e] &&
                  (e = s.options.menuItemDefinitions[e]),
                et(e, !0))
              ) {
                let t;
                e.separator
                  ? (t = J("hr", void 0, void 0, f))
                  : ("viewData" === e.textKey &&
                      s.isDataTableVisible &&
                      (e.textKey = "hideData"),
                    (t = J(
                      "li",
                      {
                    ...
                    l.styledMode ||
                      ((t.onmouseover = function () {
                        _(this, c?.menuItemHoverStyle || {});
                      }),
                      (t.onmouseout = function () {
                        _(this, c?.menuItemStyle || {});
                      }),
                      _(t, Z({ cursor: "pointer" }, c?.menuItemStyle || {})))),
                  s.divElements.push(t);
              }
            }),
            s.divElements.push(f, m),
            (s.menuHeight = m.offsetHeight),
            (s.menuWidth = m.offsetWidth));
          let y = { display: "block" };
          n + (s.menuWidth || 0) > h
            ? (y.right = h - n - o - g + "px")
            : (y.left = n - g + "px"),
            i + r + (s.menuHeight || 0) > p &&
            a.alignOptions?.verticalAlign !== "top"
              ? (y.bottom = p - i - g + "px")
              : (y.top = i + r - g + "px"),
            _(m, y),
            _(l.renderTo, { overflow: "" }),
            _(l.container, { overflow: "" }),
            l.exporting && (l.exporting.openMenu = !0),
            ee(l, "exportMenuShown");
        }
        destroy(e) {
          let t,
            ...
            try {
              ...
              if (n && i && l) {
                ...
                (t.width = c),
                  (t.height = h),
                  q.canvg ||
                    ((eh.objectURLRevoke = !0), await I(s + "canvg.js")),
                  q.canvg.Canvg.fromString(n, e).start(),
                  U(
                    q.navigator.msSaveOrOpenBlob
                      ? t.msToBlob()
                      : t.toDataURL(o),
                    r
                  );
        ...
        async exportChart(e, t) {
          if ((e = en(this.options, e)).local)
            await this.localExport(e, t || {});
          else {
        ...
        getSVG(e) {
          let t = this.chart,
            ...
            i,
            o = en(t.options, e);
          (o.plotOptions = en(t.userOptions.plotOptions, e?.plotOptions)),
            (o.time = en(t.userOptions.time, e?.time));
          let r = J(
              "div",
              void 0,
              {
          ...
          t.axes.forEach(function (e) {
            e.userOptions.internalKey || (e.userOptions.internalKey = el()),
              o &&
          ...
          return (
            ...
            ee(t, "getSVG", { chartCopy: p }),
            (n = eh.sanitizeSVG(n, o)),
            (o = void 0),
            p.destroy(),
            X(r),
            n
        ...
        getSVGForExport(e, t) {
          let n = this.options;
          return this.getSVG(
            en({ chart: { borderRadius: 0 } }, n.chartOptions, t, {
              exporting: {
        ...
        inlineStyles() {
          ...
          r && r.body.appendChild(r.createElementNS(W, "svg")),
            !(function o(a) {
              let s,
                l,
                c,
              ...
              if (
                r &&
                1 === a.nodeType &&
                -1 === eh.unstyledElements.indexOf(a.nodeName)
              ) {
                if (
                  ((s = q.getComputedStyle(a, null)),
                  (l =
                    "svg" === a.nodeName
                      ? {}
                      : q.getComputedStyle(a.parentNode, null)),
                  !i[a.nodeName])
                ) {
                  (e = r.getElementsByTagName("svg")[0]),
                    (c = r.createElementNS(a.namespaceURI, a.nodeName)),
                    e.appendChild(c);
                  let t = q.getComputedStyle(c, null),
                    n = {};
                  for (let e in t)
                    e.length < 1e3 &&
                      "string" == typeof t[e] &&
                ...
                for (let e in s)
                  (G || $ || V || Object.hasOwnProperty.call(s, e)) &&
                    (function (e, o) {
                      if (((h = p = !1), n.length)) {
                      ...
                      !h &&
                        ...
                        -1 === eh.inlineToAttributes.indexOf(o)
                          ? (u[o] = e)
                          : e && a.setAttribute(eh.hyphenate(o), e));
                    })(s[e], e);
                if (
                  (_(a, u),
        ...
        async localExport(e, t) {
          ...
          if (
            ($ &&
              n.styledMode &&
              !eh.inlineAllowlist.length &&
              eh.inlineAllowlist.push(
                /^blockSize/,
                /^border/,
                /^caretColor/,
                /^color/,
          ...
          try {
            ...
            for (let n of (this.getSVGForExport(e, t), a ? Array.from(a) : []))
              if (
                (r = n.getAttributeNS("http://www.w3.org/1999/xlink", "href"))
              ) {
                eh.objectURLRevoke = !1;
                let t = await eh.imageToDataURL(
                  r,
                  e?.scale || 1,
                  e?.type || "image/png"
                );
            ...
            s &&
              ...
              (await eh.inlineFonts(s));
            let l = ((n = i?.innerHTML), eh.sanitizeSVG(n || "", o));
            if (
            ...
            return (
              await this.downloadSVG(l, Z({ filename: this.getFilename() }, e)),
              l
            );
          } catch (t) {
            ...
            i &&
              ...
              e.group ||
                (e.group = t.renderer
                  ...
                  .attr({ zIndex: 3 })
                  .add()),
              ei(n?.buttons, function (t) {
                e.addButton(t);
              }),
              (e.isDirty = !1));
        }
        resolveCSSVariables() {
          Array.from(this.chart.container.querySelectorAll("*")).forEach(
            (e) => {
      ...
      (eh.inlineAllowlist = []),
        ...
        (eh.loadEventDeferDelay = 150 * !!$),
        (eh.unstyledElements = ["clipPath", "defs", "desc"]),
        (function (e) {
          function t(e) {
            let t = e.exporting;
            t &&
          ...
          function n() {
            ...
            t.options.exporting &&
              ...
              f.compose(t).navigation.addUpdate((e, n) => {
                t.exporting &&
                  ((t.exporting.isDirty = !0),
                  en(!0, t.options.navigation, e),
                  eo(n, !0) && t.redraw());
              }));
          }
          ...
          e.compose = function (o, r) {
            E.compose(r),
              ...
              er(j, "Exporting") &&
                ...
                z(o, "layOutTitle", i),
                V &&
                  q.matchMedia("print").addListener(function (t) {
                    e.printingChart &&
                      (t.matches
      ...
      let ep = eh,
        ed = h();
      (ed.Exporting = ep),
        (ed.HttpUtilities = ed.HttpUtilities || M),
        (ed.ajax = ed.HttpUtilities.ajax),
        (ed.getJSON = ed.HttpUtilities.getJSON),
        (ed.post = ed.HttpUtilities.post),
        ep.compose(ed.Chart, ed.Renderer);
      let eu = h();
      return l.default;
    })()
  )
