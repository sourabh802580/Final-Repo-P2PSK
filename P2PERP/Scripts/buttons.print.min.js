    ...
    ? ((o = require("jquery")),
      ...
      "undefined" == typeof window
        ? (module.exports = function (t, e) {
            return (
              (t = t || window), (e = e || o(t)), r(t, e), n(e, t, t.document)
            );
          })
    ...
    (e.ext.buttons.print = {
      ...
      action: function (t, e, n, o, r) {
        var i = e.buttons.exportData(
            f.extend({ decodeEntities: !1 }, o.exportOptions)
          ),
        ...
        o.header &&
          (s +=
            ...
            "</thead>"),
          (s += "<tbody>");
        for (var c = 0, d = i.body.length; c < d; c++)
          s += (function (t, e) {
        ...
        if (l) {
          l.document.close();
          var p = "<title>" + a.title + "</title>";
          f("style, link").each(function () {
            p += (function (t) {
              t = f(t).clone()[0];
              return (
                "link" === t.nodeName.toLowerCase() && (t.href = b(t.href)),
                t.outerHTML
              );
            })(this);
          });
          try {
            l.document.head.innerHTML = p;
          } catch (t) {
            f(l.document.head).html(p);
          }
          o.customScripts &&
            o.customScripts.forEach(function (t) {
              var e = l.document.createElement("script");
              (e.src = t),
                l.document.getElementsByTagName("head")[0].appendChild(e);
            }),
            (l.document.body.innerHTML =
              ...
              (a.messageBottom || "") +
              "</div>"),
            f(l.document.body).addClass("dt-print-view"),
            f("img", l.document.body).each(function (t, e) {
